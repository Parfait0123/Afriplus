...
4. [Accueil & Navigation](#-accueil--navigation)
5. [Les actualités](#-les-actualités)
6. [Les bourses d'études](#-les-bourses-détudes)
7. [Les opportunités professionnelles](#-les-opportunités-professionnelles)
8. [Les événements](#-les-événements)
9. [Rechercher un contenu](#-rechercher-un-contenu)
10. [S'abonner à la newsletter](#-sabonner-à-la-newsletter)
11. [Votre profil & tableau de bord](#-votre-profil--tableau-de-bord)
...
Mot de passe              [________________________]  (min. 8 caractères)
Confirmer le mot de passe [________________________]
```
...
> ⚠️ **N'oubliez pas** : Vérifiez votre dossier spam si vous ne trouvez pas l'email
...
- **Temps de lecture** : 3-5 minutes pour une lecture rapide

### Lire un article complet

1. Cliquez sur l'article qui vous intéresse
...
💰 Couverture complète | ⏰ Deadline: 31 Mai 2026
Organisation: Institut Africain des Études
```
...
Tri:
  ├─ Plus urgente (deadline proche)
  ├─ Plus récente
  ├─ Montant le plus élevé
  └─ Couverture complète d'abord
```

### Voir une bourse en détail

1. Cliquez sur la bourse convoitée
2. Accédez à la page complète avec :
...
│  🎓 Niveau                      │
│  💰 Financement                 │
│  ⏰ Deadline: XX Mois 20XX      │
│  🚨 URGENT (si < 1 mois)       │
│                                 │
│  ═══ DESCRIPTION DÉTAILLÉE ══   │
│  • Qu'est-ce que la bourse      │
│  • Éligibilité critique         │
...
✅ **Lire les critères d'éligibilité** : Avant de postuler, vérifiez que vous êtes éligible  
✅ **Vérifier la deadline** : Ne tardez pas, postulez au moins 2 semaines avant  
✅ **Préparer les documents** : Réunissez tous les documents avant de commencer  
✅ **Sauvegarder les liens** : Gardez les liens des pages officielles pour la référence  
✅ **Prendre des notes** : Notez les requêtes de chaque bourse pour votre dossier
...
Tri:
  ├─ Les plus récentes
  ├─ Salaire élevé
  ├─ Companies populaires
  └─ Urgentes
```

### Consulter une opportunité
...
3. Vous pouvez voir le statut :
   - 📝 **En révision** : L'équipe RH examine votre candidature
   - 👁️ **Présélectionné** : Vous êtes sélectionné pour la suite
   - 📞 **Entretien programmé** : Date/heure de l'entretien
   - ✅ **Acceptée** : Bienvenue dans l'équipe !
   - ❌ **Rejetée** : Merci de votre intérêt

### Conseils pour l'emploi

✅ **CV percutant** : Présentez votre meilleure version optimisée  
...
│                                  │
│  ⏰ AGENDA DÉTAILLÉ             │
│  09h00 - Accueil & Networking   │
│  10h00 - Keynote d'ouverture   │
│  ...                            │
│                                  │
│  🎫 [BOUTON] S'INSCRIRE         │
│  🗓️ [SAUVGARDER] Dans mon cal   │
└──────────────────────────────────┘
```
...
- 🔗 Lien de connexion (si virtuel)

### Après l'événement

- Connectez-vous avec attendus (si forum)
- Donner retours / feedback
- Consulter les ressources partagées
- Revoir les présentations enregistrées

### Conseils pour les événements

✅ **Préparez votre pitch** : Ayez une présentation courte de vous-même  
...
`www.afripulse.com/recherche?q=mon-terme`
...
Extrait: "La blockchain transforme le paysage digital africain...
Lire l'article →
```
...
Deadline: 31 Juillet 2026 | Couverture: Complète
Voir la bourse →
```
...
Entreprise: TechCorp Africa | Salaire: 150k-200k USD
Postuler →
```
...
✅ **Mots-clés précis** : "Développeur Python" plutôt que "travail"  
...
✅ **Actualités curatées** : Les meilleures news directement dans votre inbox  
...
**Bloc "Restez informé"** en bas de la page d'accueil:

```
┌──────────────────────────────────┐
│  📬 Restez informé             │
│  Recevez les meilleures news    │
│  directement dans votre email   │
│                                  │
...
**Étape 2 : Cliquez sur "S'ABONNER"**

**Étape 3 : Confirmez votre inscription**
...
> Tous les abonnements cessent immédiatement

---

## 👤 Votre profil & tableau de bord

### Accéder à votre profil

1. Cliquez sur votre **photo/initiales** en haut à droite
2. Sélectionnez **"Mon Profil"**
3. Ou allez sur : `www.afripulse.com/dashboard`

### Tableau de bord personnel

Votre espace privé avec plusieurs sections :
...
│  ├─ Articles lus: 25                     │
│  ├─ Bourses sauvegardées: 8              │
│  ├─ Candidatures actives: 3              │
│  └─ Événements inscrits: 2               │
│                                            │
│  🎯 VOS CANDIDATURES                      │
│  ✓ Candidature 1  [05 Juin]  ✅ Accepté │
│  ⏳ Candidature 2  [27 Avril] 📞 Entretien│
│  ⏳ Candidature 3  [15 Avril] 📝 En révision│
...
│  📌 22 Mai - African Tech Summit         │
│  [Voir tous]                              │
│                                            │
│  ⚙️ ACTIONS RAPIDES                       │
│  [Éditer mon profil]  [Mes préférences]  │
│  [Historique candidatures]  [Déconnexion]│
│                                            │
└────────────────────────────────────────────┘
```
...
Cliquez sur **"Éditer mon profil"** pour modifier :

```
Prénom & Nom           [____________________]
Email                  [____________________]
Téléphone             [____________________]
Pays/Région           [____________________]
Secteur d'activité    [____________________]
Bio / À propos        [____________________]
                       (max 200 caractères)
Photo de profil       [UPLOAD]  [📷 Webcam]
```
...
Consultez l'historique complet de toutes vos candidatures :

```
OFFRE                              STATUT          DATE      ACTION
────────────────────────────────────────────────────────────────
...
Liste de tous vos événements inscrits :

```
ÉVÉNEMENT                          DATE            LIEU         STATUS
──────────────────────────────────────────────────────────────────
African Tech Summit 2026           20-22 Juin      Durban       ✅ Confirmé
Hackathon Senegal 2026             15 Juin         Dakar        ⏳ Confirmé
Web3 Masterclass                   10 Juin         En ligne     ✅ Confirmé
```
...
☑️ Nouvelles bourses
☑️ Opportunités correspondant mon profil
☑️ Rappels événements
☐ Tips & Conseils
☑️ Mises à jour compte
```
...
☐ Partager ma bio
☑️ Rester anonyme dans les stats
```
...
1. **Profil** → **"Paramètres de sécurité"**
2. Cliquez **"Changer mon mot de passe"**
3. Entrez votre **mot de passe actuel**
4. Entrez votre **nouveau mot de passe** (2x)
...
4. Cliquez **"Renvoyer l'email"** sur la page d'inscription
5. Si toujours rien, contactez le support
...
4. Ouvrez l'email reçu et cliquez le lien
5. Créez un nouveau mot de passe
6. Reconnectez-vous

---

**Q3 : Mon compte a été bloqué. Pourquoi ?**
...
Contactez support: support@afripulse.com
...
**Q5 : Puis-je rechercher par plusieurs critères ?**
...
**Q6 : Comment trier les résultats ?**
...
**Q7 : Puis-je modifier ma candidature après l'avoir soumise ?**

**R :**
Non, les candidatures ne peuvent pas être modifiées après soumission.
Si vous avez fait une erreur, contactez l'organisation RH directement.

---

**Q8 : Quand commencerai-je à voir des résultats ?**
...
**Q10 : À quelle fréquence recevrai-je les emails ?**
...
**Q11 : Puis-je me désabonner facilement ?**
...
5. 📞 Si toujours bloqué, contactez support
...
**Q16 : Est-ce que c'est vraiment gratuit ?**
...
Aucune limite, aucun frais caché.

---

**Q17 : Comment contacter le support ?**
...
- Description détaillée
- Joindre des pièces si nécessaire
```
...
- 📖 [README Technique](/README.md) - Pour les développeurs
...
1. **Profil complet** → Augmente les chances de sélection
2. **Sauvegardez vos recherches** → Retrouvez-les rapidement
3. **Postulez tôt** → Les meilleures places se remplissent vite
4. **Personnalisez votre CV** → Pour chaque candidature
5. **Newsletter** → Reste informé des opportunités fraîches
6. **Événements** → Construisez votre réseau professionnel
7. **Lire les commentaires** → Insights sur les expériences
8. **Document tous les deadlines** → Dans votre calendrier
9. **Suivez les demandes** → Préparez les documents à l'avance
10. **Recherches enregistrées** → Gagnez du temps

11. **Variez les sources** → Diversifiez vos candidatures
12. **Feedbacks positifs** → Complimentez les bonnes experiences
13. **Calendrier synchronisé** → N'oubliez jamais un deadline
14. **Clés de recherche** → Découvrez des opportunités cachées
15. **Ask for help** → Contactez le support si vous êtes bloqué
...
**Langue** : Français  
**Status** : Document officiel client

Pour toute mise à jour future, consultez [afripulse.com/aide](https://afripulse.com/aide)