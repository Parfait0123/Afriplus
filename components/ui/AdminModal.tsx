 ...
 * Modale générique réutilisable — design luxueux AroMe
 *
 * Usage :
 *   <AdminModal
 *     open={open}
    ...
    <>
      ...
      >
        <div
          style={{
            background:
              "linear-gradient(145deg, #1e1c16 0%, #161410 60%, #0e0c0a 100%)",
            ...
            boxShadow:
              "0 40px 100px rgba(0,0,0,.7), 0 10px 30px rgba(0,0,0,.4), inset 0 1px 0 rgba(255,255,255,.06)",
            pointerEvents: "all",
            opacity: visible ? 1 : 0,
            transform: visible
