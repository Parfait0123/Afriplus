...
export default function AdminTable({
  ...
  const filtered = useMemo(() => {
    return rows.filter((r) => {
      ...
      const matchFilter =
        filter === "Tous" || r.badge === filter || r.meta1 === filter;
    ...
    <div style={{ padding: "2rem 2.5rem" }}>
      ...
      >
        ...
        <Link
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLAnchorElement).style.background = "#C08435";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLAnchorElement).style.background = "#141410";
          }}
        >
          <IcoPlus /> {newLabel}
        </Link>
      ...
      >
        ...
        >
          ...
          >
            ...
            <input
              ...
              onBlur={(e) =>
                (e.currentTarget.style.borderColor = "rgba(20,20,16,.09)")
              }
            />
          </div>
        ...
        >
          ...
          {["Titre", "Catégorie", "Détail", "Statut", "Publié", "Actions"].map(
            (h) => (
              <div
                key={h}
                style={{
          ...
          <div>
            {Array.from({ length: 6 }).map((_, i) => (
              <div
                ...
                style={{
                  padding: "1rem 1.4rem",
                  borderBottom: "1px solid rgba(20,20,16,.04)",
                }}
              >
          ...
          paginated.map((row, i) => {
            ...
            const bc = row.badgeColor
              ? {
                  ...
                  bg: row.badgeBg ?? `${row.badgeColor}18`,
                }
              : BADGE_FALLBACK;
              ...
              >
                ...
                <div>
                  {row.badge ? (
                    ...
                    <span style={{ fontSize: "0.82rem", color: "#928E80" }}>
                      {row.meta1 ?? "—"}
                    </span>
                  )}
                </div>
                ...
                <div>
                  {onTogglePublish ? (
                    <button
                      onClick={() =>
                        handleTogglePublish(row.id, row.published ?? false)
                      }
                      disabled={isToggling}
                      style={{
                        display: "inline-flex",
                  ...
                  {onDelete && (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        ...
                        ).style.background = "#f5dbd5";
                      }}
                      onMouseLeave={(e) => {
                        (
                          e.currentTarget as HTMLButtonElement
                        ).style.background = "#FAEBE8";
                      }}
                    >
                      <IcoTrash />
                    </button>
