    ...
    <>
      ...
      <main style={{ background: "#F0EDE4" }}>
        ...
        <section style={{
          ...
          {/* Cercles déco */}
          <div style={{ position: "absolute", top: "-80px", right: "-80px", width: 400, height: 400, borderRadius: "50%", border: "1px solid rgba(192,132,53,.08)", pointerEvents: "none" }} />
          <div style={{ position: "absolute", top: "20px", right: "20px", width: 220, height: 220, borderRadius: "50%", border: "1px solid rgba(192,132,53,.06)", pointerEvents: "none" }} />
        ...
        {/* ── STATS ── */}
        <section style={{ background: "#fff", padding: "3.5rem 0", borderBottom: "1px solid rgba(20,20,16,.07)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 clamp(1.5rem,5vw,4rem)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: "2rem" }}>
              {STATS.map((s) => (
                <div key={s.label} style={{ textAlign: "center" }}>
                  ...
                  <div style={{ fontSize: ".75rem", fontWeight: 600, color: "#928E80", letterSpacing: ".06em" }}>
                    {s.label}
                  </div>
                </div>
              ))}
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 clamp(1.5rem,5vw,4rem)" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
              <div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem", color: "#5A5A4A", fontSize: ".92rem", lineHeight: 1.8 }}>
                  <p>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {[
                  ...
                  <div key={item.year} style={{ display: "flex", gap: "1.5rem", paddingBottom: i < arr.length - 1 ? "2rem" : 0 }}>
                    ...
                    <div style={{ paddingTop: ".6rem" }}>
                      <div style={{ fontSize: ".6rem", fontWeight: 800, letterSpacing: ".1em", textTransform: "uppercase", color: "#C08435", marginBottom: ".3rem" }}>
                        {item.year}
                      </div>
                      <div style={{ fontWeight: 700, fontSize: ".92rem", color: "#141410", marginBottom: ".35rem" }}>
                        {item.title}
                      </div>
                      <div style={{ fontSize: ".82rem", color: "#928E80", lineHeight: 1.6 }}>
                        {item.desc}
                      </div>
                    </div>
                  </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "1.5rem" }}>
              {VALUES.map((v) => (
                <div key={v.title} style={{
                  ...
                  padding: "2rem", border: "1px solid rgba(20,20,16,.07)",
                }}>
                  <div style={{ fontSize: "2rem", marginBottom: "1rem" }}>{v.icon}</div>
                  <h3 style={{ fontWeight: 800, fontSize: ".95rem", color: "#141410", marginBottom: ".6rem" }}>
                    {v.title}
                  </h3>
                  <p style={{ fontSize: ".82rem", color: "#928E80", lineHeight: 1.7 }}>
                    {v.text}
                  </p>
                </div>
              ))}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "1.25rem" }}>
              {TEAM.map((m) => (
                <div key={m.name} style={{
                  ...
                  padding: "1.75rem", border: "1px solid rgba(20,20,16,.08)",
                  ...
                  <div style={{
                    ...
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontFamily: "'Fraunces', Georgia, serif",
                    fontSize: "1.1rem", fontWeight: 900, color: m.color,
                  }}>
                    {m.initials}
                  </div>
                  <div>
                    <div style={{ fontWeight: 800, fontSize: ".95rem", color: "#141410" }}>{m.name}</div>
                    <div style={{ fontSize: ".65rem", fontWeight: 700, letterSpacing: ".06em", textTransform: "uppercase", color: "#C08435", marginTop: ".15rem" }}>
                      {m.role}
                    </div>
                  </div>
                  <p style={{ fontSize: ".8rem", color: "#928E80", lineHeight: 1.65 }}>{m.bio}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── CTA ── */}
        <section style={{
          background: "#141410", padding: "5rem 0",
          ...
          <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 clamp(1.5rem,5vw,4rem)", textAlign: "center", position: "relative" }}>
            <h2 style={{
              fontFamily: "'Fraunces', Georgia, serif",
            ...
            <p style={{ fontSize: ".95rem", color: "rgba(248,246,241,.55)", marginBottom: "2rem", lineHeight: 1.7 }}>
            ...
            <Link href="/contact">
              <button style={{
                ...
                fontSize: ".88rem", fontWeight: 800, letterSpacing: ".04em",
