  ...
  return (
    <>
      ...
      <main style={{ background: "#F0EDE4" }}>
        ...
        >
          ...
          >
            <div style={{ maxWidth: 700 }}>
              ...
              >
                AroMe est un média d'information et une plateforme
                d'opportunités conçus pour les Africains qui veulent étudier,
                travailler, entreprendre et s'engager sur leur continent et dans
                le monde.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                >
                  <p>
                    AroMe est né d'un constat simple : les informations vitales
                    pour les jeunes Africains — bourses d'études, offres
                    d'emploi, événements professionnels — sont dispersées,
                    souvent fausses, et rarement accessibles à ceux qui en ont
                    le plus besoin.
                  </p>
                  <p>
                    Nous avons commencé par un newsletter envoyé à 200 abonnés
                    depuis Dakar. Aujourd'hui, la plateforme compte plus de 180
                    000 utilisateurs actifs dans 54 pays, et notre équipe de
                    vérification traite chaque publication manuellement.
                  </p>
                  <p>
                    Notre promesse reste la même :{" "}
                    <strong style={{ color: "#141410" }}>
                      une information vérifiée, gratuite, et utile dès la
                      première lecture.
                    </strong>
                  </p>
                </div>
              ...
              <div style={{ flex: 1, width: "100%" }}>
                {[
                  {
                    year: "2021",
                    title: "Le premier newsletter",
                    desc: "200 abonnés, une équipe de deux personnes, un engagement : ne publier que ce qui est vérifié.",
                  },
                  {
                    year: "2022",
                    title: "La plateforme bourses",
                    desc: "Lancement du module dédié aux bourses avec 340 programmes référencés dès le premier mois.",
                  },
                  {
                    year: "2023",
                    title: "Suivi de candidature",
                    desc: "Les utilisateurs peuvent désormais gérer toute leur démarche directement sur AroMe.",
                  },
                  {
                    year: "2024",
                    title: "180 000 utilisateurs",
                    desc: "La communauté dépasse les 180 000 membres actifs. Expansion vers les opportunités et événements.",
                  },
                ].map((item, i, arr) => (
                  <div
                    key={item.year}
        ...
        {/* ── VALEURS ── */}
        <section
          style={{ background: "#fff", padding: "clamp(2.5rem,6vw,5rem) 0" }}
        >
          <div
            style={{
              maxWidth: 1100,
        ...
        >
          ...
          >
            ...
            >
              Partenariats, signalement d'erreur, suggestion de bourse — notre
              équipe lit chaque message.
            </p>
            <Link href="/contact">
              <button
                style={{
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "#a8722d")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background = "#C08435")
                }
              >
                Nous contacter →
              </button>
