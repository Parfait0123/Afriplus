...
// On garde le mode dynamique pour Supabase
export const dynamic = "force-dynamic";

// 2. On déplace la logique dans un sous-composant
    ...
    <div style={{ minHeight: "100vh", background: "#F8F6F1", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
      ...
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 28, padding: "2.5rem", boxShadow: "0 12px 40px rgba(20,20,16,.10)" }}>
          ...
          >
            {/* SVG Google */}
            <svg width="16" height="16" viewBox="0 0 48 48" fill="none"><path d="M43.6 20.5H42V20H24v8h11.3C33.7 32.7 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.1 7.9 3l5.7-5.7C34.5 6.5 29.6 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.3-.4-3.5z" fill="#FFC107"/><path d="M6.3 14.7l6.6 4.8C14.6 15.5 19 12 24 12c3.1 0 5.8 1.1 7.9 3l5.7-5.7C34.5 6.5 29.6 4 24 4 16.3 4 9.7 8.4 6.3 14.7z" fill="#FF3D00"/><path d="M24 44c5.5 0 10.4-2 14.1-5.3l-6.5-5.5C29.6 35.1 27 36 24 36c-5.3 0-9.7-3.2-11.3-7.8L6 33.3C9.3 39.7 16.1 44 24 44z" fill="#4CAF50"/><path d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4-4 5.2l6.5 5.5C37.4 38.8 44 34 44 24c0-1.2-.1-2.3-.4-3.5z" fill="#1976D2"/></svg>
...
// 3. Export principal avec Suspense
...
// Styles inchangés
const labelStyle: React.CSSProperties = { display: "block", fontSize: "0.8rem", fontWeight: 600, color: "#38382E", marginBottom: "0.5rem" };
const inputStyle: React.CSSProperties = { width: "100%", background: "#F8F6F1", border: "1.5px solid rgba(20,20,16,.1)", borderRadius: 12, padding: "0.75rem 1rem", fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: "0.9rem", color: "#141410", outline: "none", boxSizing: "border-box" };
const btnPrimary: React.CSSProperties = { display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: "0.9rem", fontWeight: 700, padding: "0.85rem", borderRadius: 100, background: "#141410", color: "#fff", border: "none" };
const btnOutline: React.CSSProperties = { display: "flex", alignItems: "center", fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: "0.85rem", fontWeight: 600, padding: "0.75rem 1.2rem", borderRadius: 100, background: "transparent", color: "#38382E", border: "1.5px solid rgba(20,20,16,.12)", cursor: "pointer" };
