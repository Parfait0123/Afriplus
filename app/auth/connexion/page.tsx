      ...
      <div style={{ width: "100%", maxWidth: 440, position: "relative" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          <Link href="/" style={{
            ...
            fontSize: "2rem", fontWeight: 900, color: "#141410",
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", margin: "1.5rem 0" }}>
            ...
            <span style={{ fontSize: "0.72rem", color: "#928E80", letterSpacing: "0.05em", textTransform: "uppercase" }}>
              ou par email
            </span>
            <div style={{ flex: 1, height: 1, background: "rgba(20,20,16,.07)" }} />
          </div>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" }}>
                ...
                <Link href="/auth/mot-de-passe-oublie" style={{
                  fontSize: "0.75rem", color: "#C08435", textDecoration: "none",
...
const labelStyle: React.CSSProperties = {
  ...
  color: "#38382E", marginBottom: "0.5rem",
};
