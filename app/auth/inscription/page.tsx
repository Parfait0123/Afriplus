...
export default function InscriptionPage() {
  ...
  const strengthColor = ["", "#B8341E", "#C08435", "#1A5C40", "#1A5C40"][strength];
  const strengthLabel = ["", "Trop court", "Moyen", "Bon", "Excellent"][strength];
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            color: "#141410", marginBottom: "0.75rem",
          }}>
            Vérifiez vos emails
          </h2>
          <p style={{
            fontSize: "0.9rem", color: "#928E80",
            lineHeight: 1.75, marginBottom: "2rem",
          }}>
            Un lien de confirmation a été envoyé à{" "}
            <strong style={{ color: "#141410" }}>{email}</strong>.{" "}
            Cliquez dessus pour activer votre compte et compléter votre profil.
          </p>
          <Link href="/auth/connexion" style={{
            display: "inline-flex", padding: "0.82rem 1.8rem",
            borderRadius: 100, background: "#141410",
  ...
  return (
    <div style={{
      ...
      <Link href="/" style={{
        ...
        fontFamily: "'DM Sans', system-ui, sans-serif",
        fontSize: "0.82rem", fontWeight: 600, color: "#928E80",
      ...
      <div style={{ width: "100%", maxWidth: 440, position: "relative" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
          ...
          <p style={{ fontSize: "0.9rem", color: "#928E80", marginTop: "0.5rem" }}>
            Rejoignez la communauté AfriPulse — c&apos;est gratuit
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: "#1A5C40", background: "#EAF4EF",
          ...
          <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
            {error && (
              <div style={{
                ...
                fontSize: "0.82rem", color: "#B8341E", fontWeight: 500,
              }}>
                ⚠️ {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                placeholder="Kofi Mensah" required style={inputStyle}
            ...
            <div>
              ...
              <input
                ...
                placeholder="8 caractères minimum" required style={inputStyle}
                onFocus={e => (e.currentTarget.style.borderColor = "#C08435")}
                onBlur={e => (e.currentTarget.style.borderColor = "rgba(20,20,16,.1)")}
              />
              {/* Barre de force */}
              {password && (
                <div style={{ marginTop: "0.5rem" }}>
                  <div style={{ display: "flex", gap: "4px" }}>
                    {[1, 2, 3, 4].map(i => (
                      <div key={i} style={{
                        ...
                        background: i <= strength ? strengthColor : "rgba(20,20,16,.1)",
                  ...
                  <p style={{
                    ...
                    color: strengthColor, fontWeight: 500,
                  }}>
                    {strengthLabel}
                  </p>
                </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Répétez le mot de passe" required style={inputStyle}
                onFocus={e => (e.currentTarget.style.borderColor = "#C08435")}
                onBlur={e => (e.currentTarget.style.borderColor = "rgba(20,20,16,.1)")}
              />
              ...
              {confirm && (
                <p style={{
                  fontSize: "0.7rem", marginTop: "0.3rem", fontWeight: 500,
            ...
            <p style={{ fontSize: "0.73rem", color: "#928E80", lineHeight: 1.65, margin: 0 }}>
              En vous inscrivant, vous acceptez nos{" "}
              <Link href="/cgu" style={{ color: "#C08435", textDecoration: "none" }}>CGU</Link>
              {" "}et notre{" "}
...
const labelStyle: React.CSSProperties = {
  ...
  fontWeight: 600, color: "#38382E", marginBottom: "0.5rem",
};
