    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#B8341E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <p style={{
          ...
          Conformément aux conditions d'utilisation d'AfriPulse
        </p>
      </div>
    </div>
  );
