...
const SECTIONS = [
    ...
    content: [
      {
        ...
        text: `AroMe propose un outil de suivi de candidatures permettant aux utilisateurs de gérer leurs démarches pour des bourses et opportunités. Cet outil est un outil personnel de gestion et de mémorisation. Il ne constitue pas un service de candidature officiel : AroMe n'envoie pas vos candidatures aux organisateurs et n'agit pas en tant qu'intermédiaire officiel entre vous et ces organisateurs.`,
      },
      {
        subtitle: "3.2 Responsabilité des données de candidature",
        text: `Les données que vous enregistrez dans l'outil de suivi (statuts, notes personnelles, liste de documents) sont strictement personnelles et privées. AroMe ne les consulte jamais et ne les transmet à aucun tiers. Vous êtes seul responsable de l'exactitude des informations que vous y enregistrez. AroMe ne saurait être tenu responsable d'une candidature manquée ou refusée en raison d'informations erronées enregistrées dans l'outil.`,
      },
      {
        subtitle: "3.3 Vérification des opportunités publiées",
        text: `AroMe s'efforce de vérifier l'exactitude et l'actualité de chaque bourse, opportunité ou événement publié. Cependant, les informations (dates limites, montants, conditions d'éligibilité) peuvent évoluer sans que nous en soyons informés. Il vous appartient de vérifier les informations directement auprès des organisateurs avant de soumettre une candidature. AroMe ne peut être tenu responsable d'une candidature fondée sur des informations devenues obsolètes.`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        subtitle: "5.1 Propriété du contenu AroMe",
        text: `L'ensemble des contenus produits par AroMe (articles, analyses, fiches de bourses, descriptions d'opportunités, code source de la plateforme, design, logos, marques) est protégé par le droit d'auteur et appartient exclusivement à AroMe ou à ses partenaires. Toute reproduction, même partielle, sans autorisation écrite préalable est interdite. Pour toute demande de reproduction ou de partenariat éditorial, contactez editorial@afripulse.com.`,
      },
      {
        subtitle: "5.2 Utilisation autorisée",
        text: `Vous êtes autorisé à consulter, télécharger et imprimer les contenus AroMe pour un usage personnel et non commercial. Vous pouvez partager des liens vers nos articles et fiches de bourses sur vos réseaux sociaux ou par email. Vous ne pouvez pas reproduire nos contenus sur d'autres sites web, bases de données ou publications sans autorisation.`,
      },
      {
        subtitle: "5.3 Signalement de violations",
        text: `Si vous estimez qu'un contenu publié sur AroMe porte atteinte à vos droits ou contient des informations erronées, contactez-nous à editorial@afripulse.com en précisant l'URL concernée et la nature du problème. Nous traitons chaque signalement sérieusement et dans les meilleurs délais.`,
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: `Les présentes CGU sont soumises au droit sénégalais, pays du siège social d'AroMe. En cas de litige, les parties s'engagent à rechercher une solution amiable dans un délai de 30 jours avant tout recours judiciaire. À défaut de résolution amiable, le litige sera porté devant les tribunaux compétents de Dakar, Sénégal.`,
      },
      {
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0, width: "100%" }}>
                ...
                >
                  ...
                  >
                    {[
                      "📖 AroMe est gratuit — pas d'abonnement, pas de frais cachés",
                ...
                >
                  ...
                  >
                    ...
                    d'utilisation, notre équipe juridique vous répond sous 48
                    heures.
                  </p>
                  <Link
                    href="/contact"
