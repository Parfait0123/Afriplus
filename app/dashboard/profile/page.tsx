      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: ".9rem", color: "#928E80", lineHeight: 1.7 }}>
            Bienvenue sur AroMe. Vous allez être redirigé vers votre tableau de
            bord…
          </p>
          <div
            style={{
    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 520 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p
            style={{ fontSize: ".88rem", color: "#928E80", marginTop: ".6rem" }}
          >
            {isNew
          ...
          {step === 1 && (
            ...
            >
              <div>
                ...
                <p style={subStyle}>
                  Ces informations s&apos;affichent sur votre profil public.
                </p>
              </div>
          ...
          {step === 2 && (
            ...
            >
              <div>
                ...
                <p style={subStyle}>
                  Nous personnalisons votre fil d&apos;actualités en fonction de
                  ces informations.
                </p>
              </div>
            ...
            >
              ...
              {isGoogle && (
                ...
                >
                  ...
                  >
                    <path
                      d="M43.6 20.5H24v8h11.3C33.7 32.7 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.1 7.9 3l5.7-5.7C34.5 6.5 29.6 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.3-.4-3.5z"
                      fill="#1976D2"
                    />
                  </svg>
                  <div>
                    ...
                    >
                      Votre compte est déjà sécurisé par Google. Vous pouvez
                      ajouter un mot de passe supplémentaire ci-dessous
                      (optionnel).
                    </p>
                  </div>
                </div>
                  ...
                  <div style={{ marginTop: ".5rem" }}>
                    <div style={{ display: "flex", gap: 4 }}>
                      {[1, 2, 3, 4].map((i) => {
                        const s =
                          newPwd.length >= 8
                            ? newPwd.length >= 12 && /[^a-zA-Z0-9]/.test(newPwd)
                              ? 4
                              : newPwd.length >= 10
                                ? 3
                                : 2
