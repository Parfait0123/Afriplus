      ...
      >
        ...
        <aside
          style={{
            ...
            overflowX: "hidden",
            transition:
              "width .25s cubic-bezier(.4,0,.2,1), transform .3s cubic-bezier(.4,0,.2,1)",
        ...
        >
          ...
          <div
            style={{
              ...
              height: 200,
              background:
                "radial-gradient(circle, rgba(192,132,53,.12) 0%, transparent 65%)",
              pointerEvents: "none",
              zIndex: 0,
            }}
          />
                ...
                {profile?.avatar_url ? (
                  ...
                  <div
                    style={{
                      ...
                      flexShrink: 0,
                      background:
                        "linear-gradient(135deg, #C08435 0%, #7a5220 100%)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontFamily: "'Fraunces', Georgia, serif",
...
function IcoMsg() {
  return (
    ...
    >
      ...
      <path d="M22 6V18C22 18.5304 21.7893 19.0391 21.4142 19.4142C21.0391 19.7893 20.5304 20 20 20H4C3.46957 20 2.96086 19.7893 2.58579 19.4142C2.21071 19.0391 2 18.5304 2 18V6" stroke="currentColor" />
      <path d="M2 6L12 13L22 6" stroke="currentColor" />
      <path d="M2 8L9 13" stroke="currentColor" strokeWidth="1.2" />
      <path d="M22 8L15 13" stroke="currentColor" strokeWidth="1.2" />
