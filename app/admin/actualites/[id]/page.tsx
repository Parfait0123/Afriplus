...
export default function ArticleEditorPage({
  ...
  const save = async (pub?: boolean) => {
    ...
    const payload: Record<string, unknown> = {
      ...
      published: pubNow,
      image_gradient:
        CAT_GRADIENT[state.category] ??
        "linear-gradient(135deg,#0a0800,#261e00)",
  ...
  const wordCount = [
    state.intro,
    ...state.blocks.map((b) => ("text" in b ? (b as any).text : "")),
  ]
    .join(" ")
    .trim()
    .split(/\s+/)
  ...
  const confirmPublish = async () => {
    if (!pubPassword) {
      setPubError("Entrez votre mot de passe.");
      return;
    }
    setPubLoading(true);
    setPubError("");
    ...
    <div className="aa-editor-page">
      ...
      {deleteModal && (
        ...
        >
          ...
          >
            ...
            >
              Cette action est{" "}
              <strong style={{ color: "#141410" }}>irréversible</strong>.
            ...
            <div style={{ display: "flex", gap: ".65rem" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 12,
                  cursor:
                    deleteLoading || !deletePassword ? "default" : "pointer",
                  fontFamily: "inherit",
                  fontSize: ".82rem",
                  fontWeight: 700,
                  background:
      ...
      {pubModal !== null && (
        ...
        >
          ...
          >
            ...
            >
              {pubModal
                ? "L'article sera visible par tous les visiteurs d'AroMe."
      ...
      <div className="aa-editor-topbar">
        ...
        <div className="aa-editor-indicators">
          <span className="aa-editor-wordcount">
            {wordCount} mots · ~{estTime} min
          </span>
          {hasDraft && !saving && (
            <span
      ...
      <div className="aa-editor-layout">
                ...
                <div className="aa-label-row">
                  ...
                  >
                    {state.excerpt && !state.metaDesc && (
                      <button
                        onClick={() =>
                          set("metaDesc", state.excerpt.slice(0, 160))
                        }
                        style={{
                          fontSize: ".62rem",
                          fontWeight: 600,
              ...
              <div className="aa-editor-field-group">
                ...
                <div className="aa-seo-preview">
                  <div className="aa-seo-preview-url">
                    afripulse.com › actualites › {previewSlug}
                  </div>
                  <div className="aa-seo-preview-title">
                    {state.metaTitle || state.title || "Titre de l'article"}
                  </div>
                  <div className="aa-seo-preview-desc">
                    {state.metaDesc ||
                      state.excerpt ||
                      "Description visible dans les résultats."}
                  </div>
                </div>
              </div>
            </div>
        ...
        <aside className="aa-editor-sidebar">
          <div className="aa-sidebar-card">
            ...
            <div className="aa-sidebar-row">
              ...
              <div className="aa-counter">
                <button
                  className="aa-counter-btn"
                  onClick={() =>
                    set("readingTime", Math.max(1, state.readingTime - 1))
                  }
                >
                  −
                </button>
                ...
                <button
                  className="aa-counter-btn"
                  onClick={() => set("readingTime", state.readingTime + 1)}
                >
                  +
                </button>
          ...
          <div className="aa-sidebar-card">
            ...
            {profile?.full_name && state.authorName !== profile.full_name && (
              <button
                className="aa-author-reset"
                onClick={() => {
                  set("authorName", profile.full_name ?? "");
                  set("authorId", profile.id ?? null);
                }}
              >
                ← Remettre mon nom
              </button>
