...
export const articles: Article[] = [
  {
    ...
    title:
      "L'Union Africaine signe un accord historique pour le commerce numérique panafricain",
    excerpt:
      "Les 55 États membres ont ratifié un cadre réglementaire commun pour les transactions numériques, ouvrant une nouvelle ère pour l'intégration économique et les paiements transfrontaliers sur le continent.",
    category: "Économie",
    author: "Kofi Mensah",
    date: "27 Fév 2026",
    readTime: 5,
    featured: true,
    imageGradient:
      "linear-gradient(135deg, #0a0800 0%, #1a1400 40%, #2a2000 70%, #1a1000 100%)",
    content: {
      intro:
        "Les 55 États membres de l'Union Africaine ont ratifié, lors du sommet d'Addis-Abeba, un cadre réglementaire commun pour les transactions numériques. Un tournant historique pour l'intégration économique du continent — et le signal d'une Afrique qui prend enfin en main son destin numérique.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "La salle plénière du sommet de l'UA à Addis-Abeba, lors de la signature historique du 24 février 2026.",
        ...
        },
        {
          ...
          label:
            "À lire aussi : La fintech francophone lève 2 milliards en 2025",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          caption:
            "Le paiement mobile, déjà dominant dans plusieurs pays africains, bénéficiera directement du cadre unifié.",
          credit: "© AFP",
        },
        {
          type: "heading",
        ...
        },
        {
          type: "alert",
          message:
            "⚠️ Mise en garde : L'accord exclut pour l'instant les cryptomonnaies et les actifs numériques. Un groupe de travail spécifique a été mandaté pour y répondre d'ici fin 2026.",
          variant: "warning",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          description:
            "Accéder au document officiel de 184 pages ratifié lors du sommet d'Addis-Abeba.",
          favicon: "🌐",
        },
        {
          type: "divider",
...

  {
    ...
    title:
      "Nairobi s'impose comme hub continental de l'intelligence artificielle",
    excerpt:
      "Avec plus de 120 startups IA actives en 2026, la Silicon Savannah kenyane attire capitaux-risqueurs mondiaux et ingénieurs de pointe, redéfinissant la carte technologique du continent.",
    category: "Tech",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #001a0f 0%, #002e1a 50%, #004025 100%)",
    content: {
      intro:
        "Avec plus de 120 startups IA actives en 2026, la Silicon Savannah kenyane attire capitaux-risqueurs mondiaux et ingénieurs de pointe, redéfinissant la carte technologique du continent. Nairobi n'est plus seulement le berceau de M-Pesa — c'est désormais la capitale africaine de l'intelligence artificielle.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "iHub, incubateur historique de Nairobi, est devenu un pôle d'excellence en IA avec 40 startups résidentes en 2026.",
          credit: "© iHub Nairobi",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          slug: "tech-fintech-mouvance-francophone",
          label:
            "La fintech francophone attire aussi 2 milliards d'investissements",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          caption:
            "Les chercheurs kenyans en IA publient désormais dans les grandes conférences internationales comme NeurIPS et ICML.",
          credit: "© Unsplash",
        },
        {
          type: "external",
          ...
          description:
            "Découvrir les startups résidentes et le programme d'accompagnement de l'incubateur historique.",
          favicon: "🚀",
        },
      ],
    },
...

  {
    ...
    title:
      "COP31 : l'Afrique arrache 40 milliards pour l'adaptation climatique",
    excerpt:
      "Une victoire diplomatique sans précédent pour la coalition africaine réunie à Dubaï. Ces fonds financeront des infrastructures résilientes au Sahel, des digues côtières et l'agriculture régénérative.",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #001018 0%, #001a28 50%, #002535 100%)",
    content: {
      intro:
        "C'était la demande la plus ambitieuse jamais portée par la coalition africaine dans une COP. Et pour la première fois, elle a été entendue. 40 milliards de dollars engagés spécifiquement pour l'adaptation climatique du continent — un résultat que beaucoup jugeaient impossible il y a encore six mois.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "La délégation africaine en session plénière à la COP31, Dubaï. Une cohésion diplomatique sans précédent.",
        ...
        },
        {
          ...
          caption:
            "Le lac Tchad a perdu 90 % de sa superficie depuis 1960. Les fonds de la COP31 financeront des projets de revitalisation.",
        ...
        },
        {
          type: "alert",
          message:
            "💡 À suivre : La première réunion du Comité de Gouvernance du fonds est prévue en juin 2026 à Nairobi. Les organisations africaines de la société civile réclament d'y être représentées.",
          variant: "info",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          description:
            "Consulter les documents de la décision et les mécanismes de vérification du fonds.",
          favicon: "🌍",
        },
      ],
    },
...

  {
    ...
    title:
      "Le Nigeria consolide sa position de 2ème économie africaine malgré les turbulences",
    excerpt:
      "La diversification économique porte ses fruits avec une croissance de 4,2 % au T4 2025. L'agriculture, le pétrole raffiné et les services numériques tirent l'expansion dans un contexte mondial incertain.",
    category: "Économie",
    author: "Emeka Okafor",
    date: "24 Fév 2026",
    readTime: 7,
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Lagos, moteur économique du Nigeria avec 25 millions d'habitants et un PIB supérieur à celui de nombreux États africains.",
        ...
        },
        {
          ...
          slug: "union-africaine-accord-commerce-numerique",
          label:
            "L'accord numérique de l'UA : une opportunité pour les startups nigérianes",
        },
        {
          type: "paragraph",
        ...
        },
        {
          type: "alert",
          message:
            "⚠️ Nuance : Les chiffres officiels excluent l'économie informelle, qui représente entre 40 et 65 % de l'activité réelle selon les estimations. La croissance ressentie par la population reste très inégale.",
          variant: "warning",
        },
      ],
    },
...

  {
    ...
    title:
      "Record absolu : 18 médailles d'or africaines aux Mondiaux d'Athlétisme",
    excerpt:
      "L'Afrique réécrit l'histoire du sport mondial à Tokyo. L'Éthiopie, le Kenya et le Maroc dominent le fond, tandis que le Nigeria émerge sur le sprint.",
    category: "Sport",
    author: "Léa Mobutu",
    date: "23 Fév 2026",
    readTime: 3,
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #0e0005 0%, #1a000a 50%, #260010 100%)",
    content: {
      intro:
        "Dix-huit médailles d'or. Un record absolu, un continent au sommet, et une domination qui ne doit plus rien au hasard. Aux Championnats du Monde d'Athlétisme de Tokyo, l'Afrique a écrit une nouvelle page de sa légende sportive.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Podium du 5 000m hommes aux Mondiaux de Tokyo : trois athlètes africains, trois drapeaux différents.",
...

  {
    ...
    excerpt:
      "42 pays ont signé l'accord de libre circulation. Dès juillet 2026, leurs ressortissants pourront voyager sans visa dans toute la zone.",
    category: "Politique",
    author: "Mamadou Sy",
    date: "22 Fév 2026",
    readTime: 5,
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #050010 0%, #0a0020 50%, #10003a 100%)",
    content: {
      intro:
        "Un Ivoirien qui prend l'avion pour Accra sans visa. Un Sénégalais qui traverse la frontière du Mali avec sa carte d'identité. Un Rwandais qui s'installe à Nairobi sans permis de travail. À partir de juillet 2026, ce sera la réalité pour les ressortissants des 42 pays signataires du Protocole de Libre Circulation de l'UA.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "L'aéroport international d'Abidjan, l'un des plus fréquentés d'Afrique de l'Ouest, où les contrôles aux frontières évolueront dès juillet.",
          credit: "© AERIA",
        },
        {
          type: "pullquote",
        ...
        },
        {
          type: "alert",
          message:
            "💡 Calendrier : Déploiement en trois phases. Phase 1 (juillet 2026) : suppression des visas. Phase 2 (jan 2027) : droit de résidence. Phase 3 (jan 2028) : droit au travail harmonisé.",
          variant: "info",
        },
        {
          type: "related",
          slug: "union-africaine-accord-commerce-numerique",
          label:
            "L'accord numérique de l'UA : l'autre révolution de l'intégration",
        },
        {
          type: "paragraph",
...

  {
    ...
    excerpt:
      "Cinq auteurs africains figurent parmi les dix best-sellers mondiaux en 2025. De Chimamanda à Boubacar Boris Diop, une génération transcontinentale impose ses récits.",
    category: "Culture",
    author: "Zara Ndiaye",
    date: "21 Fév 2026",
    readTime: 4,
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #0a0500 0%, #1a0e00 50%, #2e1800 100%)",
    content: {
      intro:
        "Pour la première fois de l'histoire du classement mondial des ventes de livres, cinq des dix titres les plus vendus en 2025 sont signés par des auteurs africains. Ce n'est pas une mode — c'est l'aboutissement d'une renaissance littéraire silencieuse qui couvait depuis une décennie.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            'Les rayons "Littérature africaine" des librairies parisiennes et londoniennes ont doublé de surface en trois ans.',
        ...
        },
        {
          ...
          label:
            "L'Afrobeats franchit aussi le milliard de dollars — la culture africaine en conquête",
        },
        {
          type: "alert",
          message:
            "📚 À noter : Le FESPACO Littéraire, pendant du célèbre festival de cinéma, sera lancé à Ouagadougou en septembre 2026. Une première continentale.",
          variant: "tip",
        },
      ],
    },
...

  {
    ...
    excerpt:
      "La campagne nationale cible 14 millions d'enfants. Si les projections se confirment, le pays pourrait diviser sa mortalité paludéenne par trois d'ici 2028.",
    category: "Santé",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #001005 0%, #001a0a 50%, #002814 100%)",
    content: {
      intro:
        "La République Démocratique du Congo lance la plus grande campagne de vaccination antipaludéenne de son histoire. 14 millions d'enfants de moins de cinq ans dans 26 provinces seront vaccinés avec le RTS,S — le premier vaccin efficace contre le paludisme — entre mars et décembre 2026.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Un agent de santé communautaire vaccine un enfant dans la province du Kasaï. La chaîne du froid est assurée par des frigos solaires financés par Gavi.",
        ...
        },
        {
          ...
          label:
            "Le Rwanda produit son propre vaccin contre le Mpox — la souveraineté sanitaire avance",
        },
        {
          type: "image",
          ...
          caption:
            "Centre de santé de référence dans la province du Nord-Kivu, l'une des zones prioritaires de la campagne.",
        ...
        },
        {
          ...
          description:
            "La recommandation historique de l'OMS d'octobre 2021 qui a ouvert la voie au déploiement mondial.",
          favicon: "🏥",
        },
      ],
    },
...

  {
    ...
    slug: "maroc-energie-solaire-exportateur",
    title:
      "Le Maroc devient le premier exportateur africain d'énergie solaire vers l'Europe",
    excerpt:
      "Le câble sous-marin Xlinks entre Guelmim et Devon est opérationnel. Le Maroc injecte 3,6 GW dans le réseau britannique.",
    category: "Environnement",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #1a0800 0%, #2e1200 50%, #3e1c00 100%)",
    content: {
      intro:
        "Le câble sous-marin de 3 800 kilomètres qui relie les champs solaires et éoliens de Guelmim-Oued Noun (Maroc) au Devon (Royaume-Uni) est désormais pleinement opérationnel. Une prouesse d'ingénierie qui fait du Maroc le premier exportateur africain d'énergie propre vers l'Europe.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Les champs solaires de Noor Ouarzazate, complétés par le parc de Guelmim, alimentent désormais directement le réseau britannique.",
        ...
        },
        {
          ...
          label:
            "L'Algérie prépare aussi l'exportation d'hydrogène vert vers l'Europe",
        },
        {
          type: "paragraph",
        ...
        },
        {
          type: "alert",
          message:
            "🌍 Impact régional : L'excédent de production (estimé à 600 MW) sera redistribué dans le réseau électrique maghrébin, permettant à terme d'alimenter la Mauritanie, le Sénégal et le Mali.",
          variant: "tip",
        },
      ],
    },
...

  {
    ...
    excerpt:
      "Avec 100 000 barils par jour extraits depuis Sangomar, le PIB sénégalais bondit de 8,3 %. La société civile appelle à un fonds souverain transparent.",
    category: "Économie",
    author: "Rokhaya Faye",
    date: "18 Fév 2026",
    readTime: 8,
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "La plateforme FPSO Léopold Sédar Senghor, opérée par Woodside Energy, extrait 100 000 barils/jour depuis le champ de Sangomar.",
        ...
        },
        {
          ...
          slug: "nigeria-gdp-deuxieme-afrique",
          label:
            "Le Nigeria, laboratoire des succès et des échecs de l'économie pétrolière",
        },
        {
          type: "alert",
          message:
            "⚠️ Enjeu : Le Fonds Intergénérationnel prévu dans la loi pétrolière est opérationnel depuis janvier 2026, mais son conseil d'administration reste dominé par des représentants gouvernementaux. Les ONG réclament une majorité de membres indépendants.",
          variant: "warning",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          description:
            "Consulter les contrats signés, les revenus déclarés et les audits indépendants sur la plateforme ITIE.",
          favicon: "📄",
        },
      ],
    },
...

  {
    ...
    slug: "afrobeats-industrie-milliard",
    title:
      "L'Afrobeats franchit le cap du milliard de dollars de revenus mondiaux",
    excerpt:
      "Burna Boy, Tems, Davido et la nouvelle garde panafricaine font de la musique africaine une industrie mondiale.",
    category: "Culture",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #1a0010 0%, #2e001e 50%, #40002c 100%)",
    content: {
      intro:
        "1,04 milliard de dollars. C'est le chiffre d'affaires combiné de l'industrie Afrobeats en 2025, selon le rapport annuel de PwC Africa Entertainment. Un cap symbolique franchi pour une musique qui, il y a quinze ans, peinait à obtenir du temps d'antenne hors de Lagos.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Burna Boy au O2 Arena de Londres, 2025. La salle de 20 000 places affichait complet trois mois à l'avance.",
        ...
        },
        {
          ...
          label:
            "Accra cartonne aussi en mode — la créativité africaine tous azimuts",
        },
        {
          type: "paragraph",
...

  {
    ...
    title:
      "Le Grand Barrage de la Renaissance : l'Éthiopie tient ses promesses",
    excerpt:
      "Après des années de tensions avec l'Égypte et le Soudan, le GERD produit 5 150 MW et fait de l'Éthiopie un exportateur d'électricité.",
    category: "Politique",
    author: "Yonas Haile",
    date: "16 Fév 2026",
    readTime: 7,
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #000f1a 0%, #001828 50%, #002438 100%)",
    content: {
      intro:
        "Le Grand Barrage de la Renaissance Éthiopien (GERD) est pleinement opérationnel depuis janvier 2026. Avec 5 150 mégawatts de capacité installée, il est désormais le plus grand barrage d'Afrique — et la source d'une recomposition géopolitique majeure dans la région du Nil.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Le GERD vu du ciel : 1 800 mètres de long, 145 mètres de hauteur, un réservoir de 74 milliards de m³.",
        ...
        },
        {
          ...
          slug: "union-africaine-accord-commerce-numerique",
          label:
            "L'interconnexion électrique continentale, prochain chantier de l'UA",
        },
        {
          type: "alert",
          message:
            "⚠️ Tension persistante : L'Égypte n'a toujours pas signé d'accord de partage des eaux avec l'Éthiopie. Les négociations, médiées par l'UA, reprennent en mars 2026 à Khartoum.",
          variant: "warning",
        },
      ],
    },
...

  {
    ...
    slug: "tech-fintech-mouvance-francophone",
    title:
      "La fintech francophone africaine attire 2 milliards d'investissements en 2025",
    excerpt:
      "Wave, Julaya, Semoa, FlosCash — la nouvelle génération fintech d'Afrique francophone redessine l'accès aux services financiers pour 400 millions de personnes non bancarisées.",
    category: "Tech",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #001a10 0%, #002a1e 50%, #003a2a 100%)",
    content: {
      intro:
        "Longtemps dominée par ses homologues anglophones (Lagos, Nairobi, Accra), la scène fintech d'Afrique francophone connaît une explosion sans précédent. 2 milliards de dollars investis en 2025, des licornes qui émergent, et surtout des modèles business profondément adaptés aux réalités économiques locales.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Un marchand de Dakar utilise Wave pour encaisser ses clients. La solution a capté 60 % du marché sénégalais en 5 ans.",
        ...
        },
        {
          ...
          slug: "kenya-hub-ia-africain",
          label:
            "Pendant ce temps, Nairobi domine l'IA africaine — les deux scènes se rapprochent-elles ?",
        },
        {
          type: "paragraph",
...

  {
    ...
    title:
      "L'Afrique du Sud retrouve son rang de première destination touristique continentale",
    excerpt:
      "Avec 14,2 millions de visiteurs en 2025, le Cap et le Kruger captent à nouveau les grands flux mondiaux.",
    category: "Économie",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #100015 0%, #1e0028 50%, #2c003a 100%)",
    content: {
      intro:
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Le Parc National Kruger, l'une des plus grandes réserves naturelles au monde, a accueilli 2,1 millions de visiteurs en 2025.",
        ...
        },
        {
          ...
          slug: "panafrican-free-movement-visa",
          label:
            "Libre circulation en Afrique : un accélérateur pour le tourisme continental",
        },
      ],
    },
  },

  {
    ...
    title:
      "CAN 2026 : le Sénégal et le Maroc s'offrent une finale nord-ouest mémorable",
    excerpt:
      "Dakar accueille la finale continentale la plus attendue depuis vingt ans. Les Lions de la Téranga et les Lions de l'Atlas promettent un choc tactique.",
    category: "Sport",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #0a1a00 0%, #162a00 50%, #223800 100%)",
    content: {
      intro:
        "Une finale de la Coupe d'Afrique des Nations entre le Sénégal et le Maroc, à Dakar, devant 80 000 spectateurs. C'est la rencontre que tout le continent attendait — et elle aura bien lieu le 12 avril 2026 au stade Abdoulaye Wade.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Le Stade Abdoulaye Wade de Dakar, inauguré en 2022 avec une capacité de 50 000 places, sera étendu à 80 000 pour la finale.",
          credit: "© CAF Media",
        },
        {
          type: "pullquote",
        ...
        },
        {
          ...
          slug: "afrique-medailles-or-jeux-2025",
          label:
            "L'Afrique domine aussi l'athlétisme mondial — la puissance sportive continentale est totale",
        },
        {
          type: "alert",
          message:
            "📺 Diffusion : La finale sera retransmise gratuitement en clair dans les 55 pays de l'UA, une décision de la CAF pour maximiser l'audience continentale.",
          variant: "info",
        },
      ],
    },
...

  {
    ...
    slug: "sante-mpox-vaccin-africain",
    title:
      "Un vaccin africain contre le Mpox fabriqué au Rwanda — une première historique",
    excerpt:
      "L'Institut Rwandais de Biosécurité annonce la production locale du premier vaccin Mpox entièrement conçu et manufacturé sur sol africain.",
    category: "Santé",
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Les équipes de l'Institut Rwandais de Biosécurité à Kigali, où le vaccin RwaMPX a été développé en 18 mois.",
        ...
        },
        {
          ...
          slug: "vaccin-paludisme-rdc",
          label:
            "La RDC vaccine aussi massivement contre le paludisme — l'Afrique prend sa santé en main",
        },
        {
          type: "paragraph",
...

  {
    ...
    slug: "ghana-mode-africaine-capitale-mondiale",
    title:
      "Accra, nouvelle capitale mondiale de la mode africaine contemporaine",
    excerpt:
      "Le Ghana Fashion Week dépasse Lagos et Abidjan. Des créateurs comme Christie Brown reçoivent des commandes de maisons parisiennes et milanaises.",
    category: "Culture",
    author: "Ama Asante",
    date: "11 Fév 2026",
    readTime: 4,
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #1a0a05 0%, #2e1600 50%, #421e00 100%)",
    content: {
      intro:
        "Accra a toujours eu du style. Mais depuis deux ans, la capitale ghanéenne est devenue quelque chose de plus : un pôle mondial de la mode qui fait plier le genou aux grandes maisons européennes. Comment une ville ouest-africaine de 5 millions d'habitants s'est imposée à Milan, Paris et New York.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Défilé Christie Brown à la Ghana Fashion Week 2025. La créatrice a reçu des commandes de Net-a-Porter et Nordstrom dans la foulée.",
        ...
        },
        {
          ...
          slug: "afrobeats-industrie-milliard",
          label:
            "L'Afrobeats à 1 milliard de dollars — la culture africaine impose sa valeur",
        },
      ],
    },
  },

  {
    ...
    slug: "algerie-hydrogene-vert-europe",
    title:
      "L'Algérie lance son programme hydrogène vert — 15 milliards d'euros d'investissement",
    excerpt:
      "Alger signe avec l'UE le plus grand accord d'hydrogène vert de son histoire. Les premières livraisons via le gazoduc Medgaz sont prévues pour 2029.",
    category: "Environnement",
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Les immenses étendues du Sahara algérien offrent un potentiel solaire estimé à 169 000 TWh/an — soit 300 fois la consommation électrique mondiale.",
        ...
        },
        {
          ...
          slug: "maroc-energie-solaire-exportateur",
          label:
            "Le Maroc exporte déjà de l'électricité solaire vers le Royaume-Uni — la course est lancée",
        },
        {
          type: "alert",
          message:
            "💡 Enjeu géopolitique : L'accord algéro-européen réduit la dépendance de l'UE au gaz russe et crée un partenariat stratégique durable avec le Maghreb. La Commission européenne le qualifie de \"pilier de la transition énergétique sudiste\".",
          variant: "info",
        },
      ],
    },
...

  {
    ...
    title:
      "Le Rwanda, modèle mondial de gouvernance numérique pour pays émergents",
    excerpt:
      "L'ONU désigne Kigali comme laboratoire mondial d'e-gouvernement. Services publics dématérialisés, IA dans la justice, drones médicaux.",
    category: "Tech",
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Le Kigali Innovation City, campus technologique de 60 hectares qui accueille 200 startups et les centres R&D d'Alibaba, Mastercard et Volkswagen.",
        ...
        },
        {
          ...
          slug: "kenya-hub-ia-africain",
          label:
            "Nairobi l'IA et Kigali l'e-gov : deux visions complémentaires de la tech africaine",
        },
        {
          type: "paragraph",
...

  {
    ...
    title:
      "La Côte d'Ivoire transforme enfin son cacao sur place — la fin d'un paradoxe",
    excerpt:
      "Plus de 30 % du cacao ivoirien est transformé localement avant exportation. Cette montée en gamme génère 4 fois plus de valeur ajoutée.",
    category: "Économie",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #1a0500 0%, #2c0a00 50%, #3e1000 100%)",
    content: {
      intro:
        "Le paradoxe durait depuis des décennies : la Côte d'Ivoire, premier producteur mondial de cacao (40 % de la production mondiale), exportait 80 % de ses fèves brutes, laissant à la Suisse, la Belgique et les Pays-Bas le soin de les transformer en chocolat à haute valeur ajoutée. Ce paradoxe est en train de prendre fin.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Usine de transformation du cacao à Abidjan. Une fève à 2$ en fèves brutes devient un produit à 12$ en beurre de cacao transformé.",
        ...
        },
        {
          ...
          slug: "union-africaine-accord-commerce-numerique",
          label:
            "L'accord numérique de l'UA facilite aussi les transactions chocolatières panafricaines",
        },
        {
          type: "alert",
          message:
            "💡 Enjeu stratégique : L'UE a adopté en 2023 un règlement anti-déforestation qui impose la traçabilité de toute fève importée. La Côte d'Ivoire a transformé cette contrainte en opportunité : ses chocolats tracés sont désormais vendus 20 % plus cher comme \"cacao durable certifié\".",
          variant: "tip",
        },
      ],
    },
...

  {
    ...
    excerpt:
      "La Tanzanie interdit les groupes moteurs thermiques dans le parc et impose des porteurs certifiés et des équipements électriques.",
    category: "Environnement",
    author: "Aisha Mwangi",
    date: "7 Fév 2026",
    readTime: 4,
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Le glacier Furtwängler au sommet du Kilimandjaro (5 895 m). Il a perdu 85 % de sa superficie en un siècle.",
        ...
        },
        {
          ...
          slug: "cop31-afrique-financement-climat",
          label:
            "COP31 : l'Afrique a obtenu 40 Md$ pour financer ces transitions",
        },
      ],
    },
  },

  {
    ...
    title:
      "Nollywood à l'assaut des Oscars : un film nigérian finaliste pour la première fois",
    excerpt:
      "'Ife' de Kunle Afolayan entre dans la shortlist des Oscars meilleur film international.",
    category: "Culture",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #1a0008 0%, #2e0012 50%, #42001e 100%)",
    content: {
      intro:
        "'Ife' — qui signifie \"amour\" en langue yoruba — est entré dans la shortlist des Oscars du meilleur film international le 17 janvier 2026. Un film nigérian de Nollywood parmi les quinze présélectionnés pour la plus haute distinction du cinéma mondial. Une première qui n'est pas le fruit du hasard.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Kunle Afolayan sur le tournage de 'Ife' à Lagos. Le réalisateur a refusé une offre de Netflix pour conserver les droits africains.",
        ...
        },
        {
          ...
          slug: "renaissance-litteraire-africaine",
          label:
            "La littérature africaine conquiert aussi le monde — la culture continentale est en marche",
        },
      ],
    },
  },

  {
    ...
    title:
      "L'Alliance des États du Sahel : quel bilan après un an d'existence ?",
    excerpt:
      "Le Mali, le Burkina Faso et le Niger ont formé une confédération qui redessine l'architecture sécuritaire du Sahel.",
    category: "Politique",
    ...
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #0a0800 0%, #181200 50%, #241a00 100%)",
    content: {
      intro:
        "Un an après la proclamation de l'Alliance des États du Sahel (AES) par le Mali, le Burkina Faso et le Niger, le bilan est celui d'une ambition qui se heurte aux réalités d'un territoire en crise. Entre souveraineté affirmée et défis humanitaires qui s'aggravent, AroMe fait le point sur une alliance qui redessine la géopolitique continentale.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "Sommet des chefs d'État de l'AES à Bamako, décembre 2025. Ibrahim Traoré (Burkina), Assimi Goïta (Mali), Abdourahamane Tiani (Niger).",
        ...
        },
        {
          type: "alert",
          message:
            "⚠️ Situation humanitaire critique : Le PAM estime que 9,4 millions de personnes dans les trois pays de l'AES sont en situation d'insécurité alimentaire grave. Les corridors humanitaires sont partiellement bloqués.",
          variant: "warning",
        },
        {
          type: "heading",
        ...
        },
        {
          ...
          slug: "panafrican-free-movement-visa",
          label:
            "Le passeport africain sans visa — l'AES en est actuellement exclue",
        },
        {
          type: "paragraph",
        ...
        },
        {
          ...
          description:
            "Analyse indépendante de la situation humanitaire dans les pays de l'AES.",
          favicon: "📊",
        },
      ],
    },
...

  {
    ...
    excerpt:
      "Lagos, Nairobi et Le Caire accueillent des arènes d'e-sport qui attirent des millions. Des jeunes Africains gagnent parfois six chiffres en dollars.",
    category: "Tech",
    author: "Kévin Otieno",
    date: "4 Fév 2026",
    readTime: 4,
    featured: false,
    imageGradient:
      "linear-gradient(135deg, #080018 0%, #10002c 50%, #180040 100%)",
    content: {
      intro:
        "En 2025, le marché mondial de l'e-sport a généré 4,2 milliards de dollars de revenus. L'Afrique en capte encore moins de 5 % — mais cette part est en train d'exploser. Lagos, Nairobi et Le Caire sont devenues des capitales mondiales d'un sport qui n'exigeait ni stades ni subventions gouvernementales pour naître.",
      blocks: [
        {
          type: "heading",
        ...
        },
        {
          ...
          caption:
            "L'arène e-sport Mara Arena de Nairobi, ouverte en 2024, accueille 5 000 spectateurs et des tournois retransmis dans 40 pays.",
        ...
        },
        {
          ...
          slug: "kenya-hub-ia-africain",
          label:
            "Nairobi hub IA et hub e-sport : la jeunesse kenyane double la mise tech",
        },
        {
          type: "paragraph",
...
export const scholarships: Scholarship[] = [
  {
    ...
    imageGradient:
      "linear-gradient(135deg, #0a0800 0%, #1c1400 50%, #2e2000 100%)",
    tags: ["Financement total", "Master", "Leadership"],
    blocks: [
      {
        type: "paragraph",
        text: "Le Mastercard Foundation Scholars Program est l'une des bourses les plus complètes et les plus sélectives du monde. Elle couvre l'intégralité des frais de scolarité, du logement, du transport et de la vie quotidienne pour des études de Master dans des universités partenaires à travers le monde.",
      },
      {
        type: "paragraph",
        text: "Au-delà du financement, le programme investit dans le développement du leadership : chaque boursier est accompagné par un mentor, participe à des retraites de leadership et intègre un réseau mondial d'alumni africains engagés dans la transformation de leur continent.",
      },
      { type: "heading", text: "Ce que couvre la bourse", level: 2 },
      {
        ...
        items: [
          ...
          },
          {
            icon: "🏠",
            label: "Logement",
            value: "Allocation mensuelle incluse",
            highlight: false,
          },
          {
            icon: "✈️",
            label: "Transport",
            value: "Billet aller-retour international",
            highlight: false,
          },
          {
            icon: "💰",
            label: "Allocation mensuelle",
            value: "Frais de subsistance couverts",
            highlight: true,
          },
          {
            icon: "🌐",
            label: "Réseau alumni",
            value: "Accès à vie au réseau mondial",
            highlight: false,
          },
          {
            icon: "📚",
      ...
      },
      {
        type: "alert",
        message:
          "Les candidatures sont examinées sur dossier puis par entretien. La compétition est internationale — commencez votre dossier au moins 8 semaines à l'avance.",
        variant: "tip",
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "CV académique et professionnel",
            detail: "Format PDF, maximum 3 pages, en anglais ou français",
          },
          {
            label: "Lettre de motivation",
            detail:
              "1 500 mots maximum — préciser votre projet et votre impact attendu",
          },
          {
            label: "Relevés de notes officiels",
            detail:
              "Tous les diplômes depuis le baccalauréat, traduits si nécessaire",
          },
          {
            label: "2 lettres de recommandation",
            detail: "Académique + professionnel, sur papier en-tête officiel",
          },
          {
            label: "Projet de recherche / Statement of Purpose",
            detail: "2 000 mots maximum selon votre discipline",
          },
          {
            label: "Certificat de langue",
            detail: "IELTS ≥ 6.5 ou TOEFL ≥ 90 / DALF C1 selon le programme",
          },
          {
            label: "Passeport en cours de validité",
            detail: "Minimum 18 mois de validité restante",
          },
        ],
      },
      { type: "heading", text: "Comment postuler", level: 2 },
      {
        ...
        items: [
          {
            label: "Préparez votre dossier",
            desc: "Rassemblez tous les documents requis. Faites traduire ceux qui ne sont pas dans la langue du programme.",
          },
          {
            label: "Créez votre compte",
            desc: "Inscrivez-vous sur le portail officiel de candidature Mastercard Foundation Scholars.",
          },
          {
            label: "Remplissez le formulaire",
            desc: "Complétez soigneusement chaque section. Faites relire votre lettre de motivation par un tiers.",
          },
          {
            label: "Soumettez avant la deadline",
            desc: "Date limite : 31 Mars 2026. Aucun dossier tardif ne sera accepté.",
          },
        ],
      },
      {
        type: "factbox",
        title: "Conseils AroMe",
        facts: [
      ...
      {
        type: "apply",
        label: "Candidatez au Mastercard Foundation Scholars Program 2026",
        url: "https://mastercardfdn.org/all/scholars/",
        note: "Soumission uniquement via le portail officiel. Aucun dossier papier ou email accepté.",
        deadline: "31 Mars 2026",
      },
    ],
  },
    ...
    blocks: [
      ...
      { type: "heading", text: "Ce que couvre la bourse", level: 2 },
      {
        ...
        items: [
          ...
          },
          {
            icon: "💶",
            label: "Allocation mensuelle",
            value: "934 € / mois (montant 2025)",
            highlight: true,
          },
          {
            icon: "✈️",
            label: "Transport",
            value: "Indemnité voyage aller-retour",
            highlight: false,
          },
          {
            icon: "🏥",
            label: "Assurance maladie",
            value: "Couverture santé incluse",
            highlight: false,
          },
          {
            icon: "🌐",
            label: "Cours d'allemand",
            value: "Préparation linguistique offerte",
            highlight: false,
          },
          {
            icon: "📚",
            label: "Bourses supplémentaires",
            value: "Frais d'études + frais de thèse",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères d'éligibilité", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Niveau B2 minimum en allemand ou C1 en anglais (selon programme)",
          },
          {
            label:
              "Lettre d'admission ou pré-accord d'une université allemande fortement recommandé",
          },
        ],
      },
      {
        type: "alert",
        message:
          "Certains programmes DAAD nécessitent que vous ayez préalablement été accepté par une université allemande. Vérifiez les conditions spécifiques de votre programme cible.",
        variant: "warning",
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Formulaire de candidature DAAD",
            detail: "À remplir en ligne sur le portail officiel daad.de",
          },
          {
            label: "CV académique en allemand ou anglais",
            detail: "Format Europass recommandé, 2 pages maximum",
          },
          {
            label: "Lettre de motivation",
            detail:
              "2 pages maximum — expliquer le projet académique et l'intérêt pour l'Allemagne",
          },
          {
            label: "Relevés de notes et diplômes",
            detail: "Avec traduction certifiée en allemand ou anglais",
          },
          {
            label: "2 lettres de recommandation de professeurs",
            detail: "Sur papier en-tête, signées et cachetées",
          },
          {
            label: "Preuve de niveau linguistique",
            detail:
              "Certificat DAAD, TestDaF, Goethe, IELTS ou TOEFL selon le programme",
          },
        ],
      },
      { type: "heading", text: "Comment postuler", level: 2 },
      {
        ...
        items: [
          {
            label: "Choisissez votre programme",
            desc: "Parcourez les programmes Master disponibles en Allemagne sur daad.de et identifiez votre université cible.",
          },
          {
            label: "Prenez contact avec l'université",
            desc: "Envoyez un email à votre futur directeur de thèse ou au bureau des admissions pour obtenir un accord de principe.",
          },
          {
            label: "Constituez votre dossier",
            desc: "Rassemblez tous les documents, faites-les traduire si nécessaire et préparez votre lettre de motivation.",
          },
          {
            label: "Soumettez en ligne",
            desc: "Déposez votre candidature via le portail DAAD avant le 15 Avril 2026.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    amount: "Financement total",
    imageGradient:
      "linear-gradient(135deg, #06000a 0%, #0e0014 50%, #180020 100%)",
    tags: ["Commonwealth", "UK", "Développement"],
    blocks: [
      {
        type: "paragraph",
        text: "Le Commonwealth Scholarship Commission (CSC) finance des études de Master et de Doctorat au Royaume-Uni pour des ressortissants des pays membres du Commonwealth. En Afrique, ce programme cible des profils à fort potentiel de leadership capables de contribuer au développement de leurs pays.",
      },
      {
        type: "alert",
        message:
          "Cette bourse est accessible uniquement aux ressortissants des pays membres du Commonwealth. Vérifiez l'éligibilité de votre pays sur le site officiel avant de candidater.",
        variant: "info",
      },
      { type: "heading", text: "Ce que couvre la bourse", level: 2 },
      {
        ...
        items: [
          ...
          },
          {
            ...
            value: "Aller-retour économique pris en charge",
            highlight: false,
          },
          {
            icon: "💷",
            label: "Allocation mensuelle",
            value: "Frais de subsistance au taux UK",
            highlight: true,
          },
          {
            icon: "🏥",
            label: "Santé",
            value: "Exemption des frais NHS (National Health Service)",
            highlight: false,
          },
          {
            icon: "📦",
            label: "Indemnité arrivée",
            value: "Allocation unique à l'arrivée au Royaume-Uni",
            highlight: false,
          },
          {
            icon: "👨‍👩‍👦",
            label: "Supplément familial",
            value: "Possible pour conjoint et enfants à charge",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères d'éligibilité", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Licence avec mention bien ou très bien (First Class ou Upper Second)",
          },
      ...
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Formulaire de candidature CSC en ligne",
            detail: "Via le portail officiel cscuk.fcdo.gov.uk",
          },
          {
            label: "Personal Statement",
            detail:
              "500 mots — projet d'études, impact attendu au retour dans votre pays",
          },
          {
            label: "Relevés de notes et diplômes",
            detail: "Traduits et certifiés en anglais",
          },
          {
            label: "2 références académiques",
            detail: "Envoyées directement par vos référents via le portail",
          },
          {
            label: "Preuve d'anglais",
            detail: "IELTS, TOEFL ou équivalent académique reconnu",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Identifiez votre programme UK",
            desc: "Choisissez votre université et votre programme Master cible sur le site du CSC.",
          },
          {
            label: "Candidatez à l'université",
            desc: "Déposez simultanément une candidature à l'université UK visée — requis pour la plupart des programmes.",
          },
          {
            label: "Soumettez votre dossier CSC",
            desc: "Complétez et soumettez votre candidature sur le portail CSC avant le 20 Avril 2026.",
          },
          {
            label: "Entretien de sélection",
            desc: "Les candidats présélectionnés sont convoqués pour un entretien, parfois organisé dans le pays d'origine.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    imageGradient:
      "linear-gradient(135deg, #180800 0%, #2c1200 50%, #441c00 100%)",
    tags: ["Numérique", "Doctorat", "Télécoms"],
    blocks: [
      {
        type: "paragraph",
        text: "La Fondation Orange soutient des doctorants africains travaillant sur des sujets liés au numérique, aux télécommunications et à l'impact des technologies sur le développement en Afrique. Ce programme de financement partiel cible des recherches à fort potentiel d'impact continental.",
      },
      {
        type: "paragraph",
        text: "Les boursiers bénéficient non seulement d'un soutien financier mais aussi d'un accès privilégié aux laboratoires de recherche d'Orange, à ses experts techniques et à son réseau africain de partenaires académiques et industriels.",
      },
      { type: "heading", text: "Ce que couvre la bourse", level: 2 },
      {
        type: "benefits",
        items: [
          {
            icon: "💰",
            label: "Allocation mensuelle",
            value: "Financement partiel selon le projet",
            highlight: true,
          },
          {
            icon: "🔬",
            label: "Accès labo",
            value: "Laboratoires de recherche Orange",
            highlight: true,
          },
          {
            icon: "🧑‍🏫",
            label: "Encadrement",
            value: "Co-direction par un expert Orange",
            highlight: false,
          },
          {
            icon: "🌍",
            label: "Mobilité",
            value: "Frais de déplacement pour conférences",
            highlight: false,
          },
          {
            icon: "📡",
            label: "Infrastructure",
            value: "Accès aux données et plateformes Orange",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères d'éligibilité", level: 2 },
      {
        ...
        items: [
          {
            label:
              "Être inscrit en Doctorat dans une université africaine ou française",
          },
          {
            label:
              "Sujet de thèse en lien avec le numérique, les télécoms ou l'impact tech en Afrique",
          },
      ...
      },
      {
        type: "alert",
        message:
          "Ce financement est partiel : il vient en complément d'un financement doctoral existant (contrat doctoral, allocation universitaire…). Vérifiez votre situation de financement avant de candidater.",
        variant: "warning",
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            ...
            detail:
              "4 à 6 pages — problématique, méthodologie, résultats attendus et impact",
          },
          {
            label: "CV académique",
            detail: "Publications, conférences, expériences de recherche",
          },
          {
            label: "Lettre du directeur de thèse",
            detail: "Attestant l'encadrement et la qualité du projet doctoral",
          },
          {
            label: "Relevés de notes de Master",
            detail: "Avec mention explicite",
          },
          {
            label: "Lettre de motivation",
            detail:
              "Expliquer le lien entre votre recherche et les enjeux numériques africains",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Vérifiez l'éligibilité de votre sujet",
            desc: "Assurez-vous que votre thèse entre dans les thématiques ciblées (numérique, télécoms, impact tech en Afrique).",
          },
          {
            label: "Obtenez le soutien de votre directeur",
            desc: "Discutez du projet avec votre directeur de thèse — sa lettre est indispensable au dossier.",
          },
          {
            label: "Rédigez le résumé de thèse",
            desc: "C'est la pièce centrale du dossier. Soyez précis sur la méthodologie et l'impact attendu.",
          },
          {
            label: "Soumettez avant le 10 Mai 2026",
            desc: "Via le portail de la Fondation Orange. Dossier incomplet = dossier rejeté.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    amount: "Financement total",
    imageGradient:
      "linear-gradient(135deg, #080400 0%, #160c00 50%, #241400 100%)",
    tags: ["BAD", "Économie", "Recherche"],
    blocks: [
      {
        type: "paragraph",
        text: "Le Fellowship Programme de la Banque Africaine de Développement s'adresse aux économistes et chercheurs africains souhaitant approfondir leurs travaux sur les enjeux de développement du continent. Les fellows sont accueillis au siège de la BAD à Abidjan pour une période de 6 à 12 mois.",
      },
      {
        type: "paragraph",
        text: "Ce programme permet à des chercheurs de haut niveau d'accéder aux données économiques exclusives de la BAD, de collaborer avec ses équipes d'experts et de contribuer directement à la production de rapports influençant les politiques de développement africaines.",
      },
      { type: "heading", text: "Ce que couvre le fellowship", level: 2 },
      {
        ...
        items: [
          {
            icon: "💰",
            label: "Stipende mensuel",
            value: "Financement total selon le barème BAD",
            highlight: true,
          },
          {
            icon: "✈️",
            label: "Transport",
            value: "Billet aller-retour et frais de réinstallation",
            highlight: false,
          },
          {
            icon: "🏠",
            label: "Logement",
            value: "Allocation logement à Abidjan",
            highlight: false,
          },
          {
            icon: "📊",
            label: "Données exclusives",
            value: "Accès aux bases de données économiques de la BAD",
            highlight: true,
          },
          {
            icon: "🤝",
            label: "Réseau",
            value: "Collaboration directe avec des économistes senior BAD",
            highlight: false,
          },
          {
            icon: "📝",
            label: "Publication",
            value: "Opportunités de co-publication avec des experts BAD",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères d'éligibilité", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Doctorat en économie, statistique, politiques publiques ou domaine connexe",
          },
          {
            label:
              "Publication dans des revues à comité de lecture (minimum 1 article publié)",
          },
          {
            label:
              "Projet de recherche clair en lien avec les priorités de la BAD",
          },
          {
            label:
              "Maîtrise du français et/ou de l'anglais (les deux est un plus)",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Formulaire de candidature BAD",
            detail: "Disponible sur le portail afdb.org",
          },
          {
            label: "Proposition de recherche",
            detail:
              "10 pages maximum — question de recherche, données utilisées, méthodologie et contribution attendue",
          },
          {
            label: "CV académique complet",
            detail:
              "Avec liste de publications et présentations en conférences",
          },
          {
            label: "2 lettres de recommandation",
            detail:
              "D'académiciens ou d'experts en politiques de développement",
          },
          {
            label: "Copie du diplôme de Doctorat",
            detail: "Avec relevé de notes si récent",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Préparez votre proposition de recherche",
            desc: "C'est la pièce maîtresse du dossier. Elle doit être alignée avec les thèmes prioritaires de la BAD : croissance inclusive, transition énergétique, intégration régionale.",
          },
          {
            label: "Soumettez votre candidature en ligne",
            desc: "Via le portail carrières de la BAD avant le 28 Avril 2026.",
          },
          {
            label: "Évaluation par le comité",
            desc: "Votre dossier est évalué par des économistes senior BAD sur la pertinence et la faisabilité de votre projet.",
          },
          {
            label: "Entretien et sélection",
            desc: "Les candidats retenus sont conviés à un entretien avec le comité de sélection du programme.",
          },
        ],
      },
      {
    ...
    blocks: [
        ...
        items: [
          {
            icon: "🎓",
            label: "Frais de scolarité",
            value: "100 % pris en charge (Université de Cambridge)",
            highlight: true,
          },
          {
            icon: "💷",
            label: "Allocation annuelle",
            value: "Frais de subsistance au taux Cambridge",
            highlight: true,
          },
          {
            icon: "✈️",
            label: "Transport",
            value: "Billet aller-retour et frais de visa",
            highlight: false,
          },
          {
            icon: "🏥",
            label: "Santé",
            value: "Exemption NHS et assurance complémentaire",
            highlight: false,
          },
          {
            icon: "🌐",
            label: "Réseau Gates",
            value:
              "Accès à la communauté mondiale Gates Cambridge (2 000+ scholars)",
            highlight: false,
          },
          {
            icon: "📚",
            label: "Conférences",
            value: "Budget pour conférences et déplacements de recherche",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères d'éligibilité", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Candidat à un programme de recherche à l'Université de Cambridge (Doctorat MPhil ou MSc)",
          },
          {
            label:
              "Excellence académique exceptionnelle — les meilleurs dossiers mondiaux",
          },
          {
            label:
              "Leadership démontré dans un domaine avec impact social, scientifique ou culturel",
          },
          {
            label:
              "Engagement envers l'amélioration du monde — au cœur de la sélection",
          },
        ],
      },
      {
        type: "alert",
        message:
          "Vous devez d'abord postuler à Cambridge et obtenir une offre conditionnelle ou inconditionnelle d'admission AVANT de soumettre votre candidature Gates Cambridge.",
        variant: "warning",
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Candidature Cambridge complète",
            detail:
              "Admissions et Gates Cambridge se font simultanément via le même portail",
          },
          {
            label: "Personal Statement Gates Cambridge",
            detail:
              "1 500 mots — leadership, projet de recherche, vision du changement dans le monde",
          },
          {
            label: "Références académiques (x3)",
            detail:
              "Dont au minimum 2 académiques — envoyées directement par vos référents",
          },
          {
            label: "Transcripts complets",
            detail:
              "Tous les diplômes universitaires, avec traduction certifiée si nécessaire",
          },
          {
            label: "Proposition de recherche",
            detail:
              "Obligatoire pour le Doctorat — longueur selon les exigences du département Cambridge",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Choisissez votre superviseur à Cambridge",
            desc: "Contactez un Professeur à Cambridge dans votre domaine et obtenez un accord de supervision avant de postuler.",
          },
          {
            label: "Soumettez votre candidature Cambridge",
            desc: "Postulez à Cambridge via le portail officiel — la candidature Gates Cambridge est intégrée dans ce processus.",
          },
          {
            label: "Sélection par Gates Cambridge Trust",
            desc: "Après présélection par Cambridge, votre dossier est transmis au Trust pour évaluation du leadership et de la vision.",
          },
          {
            label: "Entretien final",
            desc: "Les candidats shortlistés sont convoqués pour un entretien panel (souvent en janvier pour la session d'automne).",
          },
        ],
      },
      {
...
export const opportunities: Opportunity[] = [
  {
    ...
    description:
      "Rejoignez l'équipe Afrique subsaharienne de la Banque Mondiale pour contribuer à l'analyse des projets de développement économique.",
    skills: [
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #000c18 0%, #001428 50%, #001e3a 100%)",
    featured: true,
    blocks: [
      {
        type: "paragraph",
        text: "La Banque Mondiale recrute un Analyste Financier Junior pour renforcer son équipe Afrique subsaharienne. Vous contribuerez directement à l'évaluation et au suivi de projets de développement économique au Kenya, en Éthiopie, en Tanzanie et en Ouganda.",
      },
      {
        type: "paragraph",
        text: "Vous produirez des rapports d'analyse destinés aux équipes régionales et aux gouvernements partenaires, et participerez aux missions de terrain sur les projets en cours.",
      },
        ...
        items: [
          {
            icon: "💰",
            label: "Rémunération",
            value: "85 000 – 110 000 USD / an",
            highlight: true,
          },
          {
            icon: "🌍",
            label: "Mobilité",
            value: "Missions terrain en Afrique subsaharienne",
            highlight: false,
          },
          {
            icon: "🏥",
            label: "Couverture santé",
            value: "Couverture médicale internationale complète",
            highlight: false,
          },
          {
            icon: "🎓",
            label: "Mentorat",
            value: "Encadrement par des économistes seniors",
            highlight: true,
          },
          {
            icon: "📚",
            label: "Formation",
            value: "Programme de développement World Bank Group",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Minimum 2 ans d'expérience en analyse financière ou économique",
          },
          {
            label:
              "Maîtrise avancée de la modélisation financière (Excel, Python ou R)",
          },
          { label: "Excellente maîtrise de l'anglais écrit et oral" },
          {
            label:
              "Sensibilité aux enjeux de développement en Afrique subsaharienne",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
        ...
        items: [
          {
            ...
            detail: "Format PDF, maximum 3 pages, en anglais",
          },
          {
            label: "Lettre de motivation",
            detail: "1 page en anglais, adressée au Hiring Manager Africa",
          },
          {
            label: "Relevés de notes universitaires",
            detail: "Master et Licence, traduits en anglais si nécessaire",
          },
          {
            label: "Références professionnelles",
            detail: "2 références avec coordonnées",
          },
        ],
      },
      { type: "heading", text: "Comment postuler", level: 2 },
        ...
        items: [
          {
            ...
            desc: "Créez votre profil sur careers.worldbank.org et soumettez avant la date limite.",
          },
          {
            label: "Présélection sur dossier",
            desc: "L'équipe RH examine les candidatures dans un délai de 3 à 4 semaines.",
          },
          {
            label: "Entretien RH + test technique",
            desc: "Entretien vidéo suivi d'un exercice de modélisation financière à réaliser en 48h.",
          },
          {
            label: "Entretien final",
            desc: "Panel avec le manager direct et un représentant senior de l'équipe Afrique.",
          },
        ],
      },
      {
      ...
      },
      {
        type: "location",
        label: "Nairobi, Kenya",
        address: "Banque Mondiale — Upperhill, Nairobi",
        mapUrl:
          "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.819!2d36.8219!3d-1.2921!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zWorld+Bank+Nairobi!5e0!3m2!1sfr!2sfr!4v1",
      },
      {
        type: "apply",
        label:
          "Postulez au poste d'Analyste Financier Junior — Banque Mondiale",
        url: "https://careers.worldbank.org",
        note: "Créez votre profil sur careers.worldbank.org et soumettez votre candidature avant le 30 Avril 2026.",
        deadline: "30 Avr 2026",
      },
    ],
  },
  {
    ...
    description:
      "Le programme JPO des Nations Unies offre une expérience professionnelle unique au sein des agences onusiennes opérant en Afrique.",
    skills: [
      "Gestion de projet",
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #080e18 0%, #0e1a2c 50%, #162a44 100%)",
    featured: false,
    blocks: [
      {
        type: "paragraph",
        text: "Le Programme JPO (Junior Professional Officer) des Nations Unies est une passerelle privilégiée vers une carrière internationale. Deux ans d'immersion dans les opérations onusiennes en Afrique, avec une responsabilisation réelle dès le premier jour.",
      },
      {
        type: "alert",
        message:
          "Ce programme est accessible uniquement aux ressortissants des pays qui le financent. Vérifiez l'éligibilité de votre nationalité sur le site du PNUD avant de candidater.",
        variant: "info",
      },
      { type: "heading", text: "Avantages & conditions", level: 2 },
      {
        ...
        items: [
          {
            icon: "🌐",
            label: "Expérience",
            value: "2 ans au sein d'une agence onusienne en Afrique",
            highlight: true,
          },
          {
            icon: "💰",
            label: "Rémunération",
            value: "Barème international ONU (P1/P2)",
            highlight: false,
          },
          {
            icon: "🏥",
            label: "Couverture santé",
            value: "Assurance médicale internationale + indemnité logement",
            highlight: false,
          },
          {
            icon: "🚀",
            label: "Débouchés",
            value: "Accès facilité aux postes permanents onusiens",
            highlight: true,
          },
          {
            icon: "🌍",
            label: "Déploiement",
            value: "Dans un pays africain selon les besoins",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Master en Relations Internationales, Développement, Droit ou Économie",
          },
          { label: "Maximum 32 ans à la date de prise de poste" },
          {
            label:
              "Maîtrise de deux langues onusiennes (français et anglais au minimum)",
          },
          {
            label:
              "Minimum 2 ans d'expérience dans le secteur humanitaire ou du développement",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Formulaire P.11 de l'ONU",
            detail:
              "À télécharger sur careers.un.org — remplace le CV standard",
          },
          {
            label: "Lettre de motivation",
            detail:
              "Maximum 1 page en anglais ou français, adressée au coordinateur JPO",
          },
          {
            label: "Copies des diplômes certifiées",
            detail: "Avec traduction officielle si nécessaire",
          },
          {
            label: "Justificatif de nationalité",
            detail: "Passeport en cours de validité",
          },
          {
            label: "2 lettres de recommandation",
            detail: "De superviseurs ou professeurs",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Vérifiez l'éligibilité",
            desc: "Confirmez que votre pays finance le programme JPO et que vous remplissez les critères d'âge.",
          },
          {
            label: "Candidature sur careers.un.org",
            desc: "Soumettez votre dossier en sélectionnant le poste JPO correspondant à votre profil.",
          },
          {
            label: "Entretien de compétences",
            desc: "Entretien structuré (Competency-Based Interview — méthode STAR) avec un panel onusien.",
          },
          {
            label: "Déploiement",
            desc: "Briefing pré-déploiement et prise de poste dans le pays africain assigné.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "Programme graduate de 2 ans au sein de la BAD, l'institution financière de référence du continent.",
    skills: [
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #120a00 0%, #261400 50%, #402200 100%)",
    featured: true,
    blocks: [
      {
        type: "paragraph",
        text: "Le Graduate Programme de la Banque Africaine de Développement est l'un des programmes de formation les plus sélectifs du continent. Pendant deux ans, vous tournerez dans plusieurs départements de la BAD avec un mentor senior dédié à chaque rotation.",
      },
      { type: "heading", text: "Avantages & conditions", level: 2 },
      {
        type: "benefits",
        items: [
          {
            icon: "💰",
            label: "Rémunération",
            value: "55 000 – 70 000 USD / an + indemnités",
            highlight: true,
          },
          {
            icon: "🏦",
            label: "Institution",
            value: "La banque de développement de référence du continent",
            highlight: true,
          },
          {
            icon: "🔄",
            label: "Rotations",
            value: "4 rotations de 6 mois dans des départements différents",
            highlight: false,
          },
          {
            icon: "👨‍🏫",
            label: "Mentorat",
            value: "Mentor senior dédié pendant toute la durée",
            highlight: false,
          },
          {
            icon: "📈",
            label: "Évolution",
            value: "Priorité aux postes permanents à l'issue du programme",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          ...
          {
            label:
              "Master en Économie, Finance, Statistique ou Politiques publiques",
          },
          { label: "Moins de 30 ans à la date de clôture" },
          {
            label:
              "Résultats académiques excellents (mention Bien recommandée)",
          },
          {
            label:
              "Maîtrise du français ET de l'anglais (les deux langues officielles de la BAD)",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Curriculum Vitae",
            detail: "Maximum 2 pages, en anglais ou français, format PDF",
          },
          {
            label: "Lettre de motivation",
            detail:
              "1 page expliquant votre intérêt pour le développement africain et la BAD",
          },
          {
            label: "Relevés de notes complets",
            detail: "Master et Licence avec mentions obtenues",
          },
          {
            label: "Attestation de nationalité",
            detail: "Passeport d'un pays membre de la BAD",
          },
          {
            label: "2 lettres de recommandation",
            detail: "D'un professeur et d'un encadrant professionnel",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Candidature sur afdb.org",
            desc: "Soumettez votre dossier sur le portail de recrutement de la BAD avant la date de clôture.",
          },
          {
            label: "Test analytique en ligne",
            desc: "Les présélectionnés passent un test de raisonnement analytique et de connaissances économiques.",
          },
          {
            label: "Entretien RH + technique",
            desc: "Entretien axé sur vos motivations puis discussion approfondie avec un économiste senior BAD.",
          },
          {
            label: "Intégration à Abidjan",
            desc: "Session d'intégration au siège avec présentation des équipes et des premiers projets.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    sector: "Tech & FinTech",
    description:
      "Pilotez le développement de produits financiers mobiles pour le marché ouest-africain au sein de l'équipe M-Pesa.",
    skills: [
      "Product Management",
      "Agile / Scrum",
      "Analyse de données",
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #001410 0%, #002820 50%, #003e30 100%)",
    featured: false,
    blocks: [
      {
        type: "paragraph",
        text: "Safaricom étend son produit M-Pesa en Afrique de l'Ouest. Vous rejoindrez l'équipe produit d'Accra pour piloter le développement de fonctionnalités adaptées aux marchés ghanéen et régional, de la définition du besoin jusqu'au lancement en production.",
      },
      { type: "heading", text: "Avantages & conditions", level: 2 },
      {
        type: "benefits",
        items: [
          {
            icon: "💰",
            label: "Rémunération",
            value: "70 000 – 95 000 USD / an",
            highlight: true,
          },
          {
            icon: "📱",
            label: "Impact produit",
            value: "Millions d'utilisateurs M-Pesa affectés par vos décisions",
            highlight: true,
          },
          {
            icon: "✈️",
            label: "Mobilité",
            value: "Déplacements entre Accra et Nairobi",
            highlight: false,
          },
          {
            icon: "🏥",
            label: "Avantages sociaux",
            value: "Assurance santé, transport, bonus annuel",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          {
            label:
              "3 à 5 ans d'expérience en Product Management, idéalement fintech ou mobile money",
          },
          { label: "Expérience Agile/Scrum en tant que Product Owner" },
          {
            label:
              "Capacité à lire et interpréter des données produit (SQL apprécié)",
          },
          {
            label:
              "Compréhension des enjeux UX/UI et collaboration avec les designers",
          },
        ...
        items: [
          {
            label: "Curriculum Vitae",
            detail:
              "PDF 2 pages en anglais — mettez en avant les produits lancés et leurs métriques",
          },
          {
            label: "Lettre de motivation",
            detail: "1 page avec un exemple de produit géré de A à Z",
          },
          {
            label: "Portfolio ou case study",
            detail: "Optionnel mais fortement recommandé",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Candidature via LinkedIn ou portail Safaricom",
            desc: "Personnalisez votre lettre pour le poste West Africa.",
          },
          {
            label: "Screening RH",
            desc: "Appel de 20 minutes pour valider votre expérience et vos attentes.",
          },
          {
            label: "Entretien produit + case study à domicile",
            desc: "60 min avec le Head of Product puis exercice de 48h : concevoir une fonctionnalité M-Pesa pour le Ghana.",
          },
          {
            label: "Panel final",
            desc: "Présentation de votre case study devant Head of Product, CTO et équipe commerciale.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "McKinsey Africa recrute des consultants juniors pour accompagner les plus grandes organisations africaines dans leurs projets de transformation.",
    skills: [
      "Problem solving",
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #0c0c18 0%, #181828 50%, #262640 100%)",
    featured: true,
    blocks: [
      {
        type: "paragraph",
        text: "McKinsey Africa recrute des consultants juniors pour intervenir sur des missions de transformation stratégique dans des secteurs variés à travers tout le continent. Vous rejoindrez des équipes pluridisciplinaires sur des projets de 4 à 8 semaines, avec une formation de classe mondiale.",
      },
      { type: "heading", text: "Avantages & conditions", level: 2 },
      {
        type: "benefits",
        items: [
          {
            icon: "💰",
            label: "Rémunération",
            value: "Package compétitif + bonus de performance",
            highlight: true,
          },
          {
            icon: "✈️",
            label: "Mobilité",
            value:
              "Missions dans toute l'Afrique subsaharienne et à l'international",
            highlight: true,
          },
          {
            icon: "📚",
            label: "Formation",
            value: "McKinsey Academy — formation de classe mondiale",
            highlight: false,
          },
          {
            icon: "🤝",
            label: "Réseau",
            value: "Accès au réseau mondial des alumni McKinsey",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          {
            label:
              "Diplôme d'une grande école ou université de premier plan (MBA, Master ou équivalent)",
          },
          { label: "Excellence académique démontrée tout au long du parcours" },
          {
            label:
              "Capacité analytique exceptionnelle et aisance avec les chiffres",
          },
          {
            label:
              "Leadership démontré dans des activités extraprofessionnelles ou associatives",
          },
          {
            label:
              "Excellent anglais et français (langue de travail selon le bureau)",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
        ...
        items: [
          {
            label: "Curriculum Vitae",
            detail:
              "1 page maximum, format McKinsey (sobre, factuel, résultats chiffrés)",
          },
          {
            label: "Relevés de notes complets",
            detail: "Depuis le baccalauréat",
          },
          {
            label: "Lettre de motivation",
            detail:
              "Optionnelle — axée sur vos motivations spécifiques pour McKinsey Africa",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Candidature sur mckinsey.com/careers",
            desc: "Soignez particulièrement la présentation de votre CV — c'est la première impression.",
          },
          {
            label: "Problem Solving Test",
            desc: "Test de raisonnement logique et analytique (PST ou McKinsey Digital Assessment).",
          },
          {
            label: "Deux tours d'entretiens de cas",
            desc: "4 case interviews au total avec consultants, managers puis partners senior.",
          },
          {
            label: "Offre et onboarding",
            desc: "Négociation salariale et intégration dans la cohorte de consultants juniors.",
          },
        ],
      },
      {
        type: "alert",
        message:
          "Les case interviews McKinsey sont très spécifiques — préparez-vous avec au moins 30 à 50 cas pratiques avant les entretiens réels. Utilisez PrepLounge et les ressources officielles McKinsey.",
        variant: "tip",
      },
      {
        type: "factbox",
      ...
      {
        type: "compare",
        title: "McKinsey vs BCG vs Bain (Africa offices)",
        columns: [
        ...
        rows: [
          {
            label: "Bureaux africains",
            values: [
              "Joburg, Lagos, Nairobi, Casablanca",
              "Joburg, Casablanca, Lagos",
              "Joburg, Nairobi",
            ],
          },
          {
          ...
          {
            label: "Secteurs phares",
            values: [
              "Énergie, Finance, Public",
              "Industrie, Tech",
          ...
          },
          {
            ...
            values: ["Forte", "Forte", "Modérée"],
          },
          {
            label: "Processus recrutement",
            values: [
              "PST + 4 cases",
              "Online + 3-4 cases",
              "Online + 3-4 cases",
      ...
      {
        type: "apply",
        label: "Postulez chez McKinsey Africa — Consultant Junior",
        url: "https://www.mckinsey.com/careers/search-jobs",
        note: "Candidatez via le portail officiel McKinsey. Le recrutement est continu — plus tôt vous postulez, mieux c'est.",
        deadline: "10 Mai 2026",
      },
    ],
  },
  {
    ...
    description:
      "Intégrez la cohorte africaine 2026 du programme d'accélération de Google. 6 mois de mentorat intensif et accès aux ressources cloud GCP.",
    skills: [
      "Entrepreneuriat",
      "Cloud GCP",
      "Growth hacking",
    ...
    remote: true,
    imageGradient:
      "linear-gradient(135deg, #001018 0%, #001e28 50%, #003040 100%)",
    featured: false,
    blocks: [
      {
        type: "paragraph",
        text: "Google for Startups Africa ouvre sa cohorte 2026 aux startups africaines les plus prometteuses. Ce programme d'accélération de 6 mois offre un accès direct aux ressources, technologies et experts de Google pour scaler à l'échelle continentale.",
      },
        ...
        items: [
          {
            icon: "☁️",
            label: "Crédits cloud",
            value: "Jusqu'à 200 000 $ de crédits Google Cloud Platform",
            highlight: true,
          },
          {
            icon: "🧑‍🏫",
            label: "Mentorat",
            value: "Experts Google en ingénierie, produit et growth",
            highlight: true,
          },
          {
            icon: "💼",
            label: "Investisseurs",
            value: "Mise en relation avec les principaux VC africains",
            highlight: false,
          },
          {
            icon: "📍",
            label: "Format",
            value: "100% remote avec sessions en présentiel à Lagos",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          {
            label:
              "Startup africaine early-stage à growth-stage avec MVP fonctionnel",
          },
          {
            label:
              "Équipe fondatrice d'au moins 2 personnes dont un profil technique",
          },
          {
            label:
              "Marché adressable clairement identifié sur le continent africain",
          },
          {
            label:
              "Disponibilité de l'équipe fondatrice pour les sessions hebdomadaires",
          },
      ...
      { type: "heading", text: "Documents requis", level: 2 },
      {
        ...
        items: [
          {
            label: "Formulaire de candidature en ligne",
            detail: "Via le portail Google for Startups Africa",
          },
          {
            label: "Pitch deck",
            detail:
              "10 à 15 slides : problème, solution, marché, traction, équipe",
          },
          {
            label: "Démonstration produit",
            detail: "Lien vers le produit ou vidéo démo de 3 minutes maximum",
          },
          {
            label: "Métriques de traction",
            detail: "Utilisateurs actifs, revenus, croissance MoM",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Candidature sur le portail GfS Africa",
            desc: "Remplissez le formulaire avant la date limite.",
          },
          {
            label: "Présélection sur dossier",
            desc: "L'équipe Google évalue la qualité du produit, la traction et le potentiel de croissance.",
          },
          {
            label: "Entretien de sélection",
            desc: "Session vidéo de 30 minutes avec l'équipe Google for Startups.",
          },
          {
            label: "Programme & Demo Day",
            desc: "6 mois de programme intensif, clôturés par un Demo Day face aux investisseurs partenaires.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "Stage de fin d'études au sein de la direction développement durable de TotalEnergies Afrique. Projets solaires et éoliens au Sénégal, Côte d'Ivoire et Mali.",
    skills: [
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #0e0500 0%, #1e0d00 50%, #2e1500 100%)",
    featured: false,
    blocks: [
      {
        type: "paragraph",
        text: "TotalEnergies Afrique recrute un stagiaire ingénieur pour rejoindre sa direction développement durable au Sénégal. Ce stage de 6 mois vous plonge dans des projets d'énergies renouvelables concrets en cours de déploiement sur le continent.",
      },
      { type: "heading", text: "Avantages & conditions", level: 2 },
      {
        type: "benefits",
        items: [
          {
            icon: "💰",
            label: "Indemnité",
            value: "Indemnité de stage + logement pris en charge",
            highlight: true,
          },
          {
            icon: "🌱",
            label: "Impact",
            value: "Contribution directe à la transition énergétique africaine",
            highlight: true,
          },
          {
            icon: "✈️",
            label: "Mobilité",
            value: "Déplacements possibles au Sénégal, Côte d'Ivoire et Mali",
            highlight: false,
          },
          {
            icon: "📋",
            label: "Suite possible",
            value: "Possibilité de CDI à l'issue selon les besoins",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          {
            label:
              "Étudiant en dernière année d'école d'ingénieurs ou Master (génie civil, électrique ou environnemental)",
          },
          {
            label:
              "Connaissances en énergie renouvelable (solaire, éolien) souhaitées",
          },
          {
            label:
              "Maîtrise d'AutoCAD ou d'un logiciel de conception technique",
          },
          {
            label:
              "Bonne maîtrise du français oral et écrit (langue de travail principale)",
          },
          {
            label:
              "Permis de conduire recommandé pour les déplacements sur site",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
        ...
        items: [
          {
            label: "Curriculum Vitae",
            detail:
              "PDF, 1 à 2 pages en français — mentionnez vos projets liés à l'énergie",
          },
          {
            label: "Lettre de motivation",
            detail:
              "1 page en français, sur votre intérêt pour les ENR en Afrique",
          },
          {
            label: "Relevés de notes récents",
            detail: "Dernières années de cursus ingénieur ou Master",
          },
          {
            label: "Convention de stage",
            detail: "Document fourni par votre école, après acceptation",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Candidature sur le portail TotalEnergies",
            desc: "Ou envoi direct à la DRH Afrique selon les instructions de l'offre.",
          },
          {
            label: "Présélection et entretien combiné",
            desc: "45 minutes : motivation, présentation d'un projet technique et questions de mise en situation.",
          },
          {
            label: "Validation et convention",
            desc: "Signature de la convention de stage avec votre établissement et TotalEnergies Afrique.",
          },
          {
            label: "Prise de poste à Dakar",
            desc: "Accueil sur site, briefing sécurité et intégration dans l'équipe développement durable.",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    sector: "Data & Banque",
    description:
      "Rejoignez l'équipe Data & IA de Bank of Africa pour développer des modèles de scoring crédit, détection de fraude et analyse comportementale client.",
    skills: [
      "Python / R",
      "Machine Learning",
      "SQL",
    ...
    remote: false,
    imageGradient:
      "linear-gradient(135deg, #080010 0%, #100020 50%, #1a0030 100%)",
    featured: false,
    applyUrl: "https://www.bankofafrica.ma/careers/data-scientist",
    blocks: [
      {
        type: "paragraph",
        text: "Bank of Africa recrute un Data Scientist pour son équipe Data & IA à Casablanca. Vous développerez des modèles à fort impact opérationnel — scoring crédit, détection de fraude, analyse comportementale — au service de 5 millions de clients sur le continent.",
      },
      { type: "heading", text: "Avantages & conditions", level: 2 },
      {
        type: "benefits",
        items: [
          {
            icon: "💰",
            label: "Rémunération",
            value: "60 000 – 80 000 MAD / an",
            highlight: true,
          },
          {
            icon: "🤖",
            label: "Stack technique",
            value: "Spark, Databricks, Python, cloud Azure",
            highlight: true,
          },
          {
            icon: "📊",
            label: "Impact",
            value: "Modèles en production, 5 millions de clients",
            highlight: false,
          },
          {
            icon: "📚",
            label: "Formation",
            value: "Budget formation annuel + certifications cloud",
            highlight: false,
          },
        ],
      },
      { type: "heading", text: "Critères de sélection", level: 2 },
      {
        ...
        items: [
          {
            label:
              "Master en Data Science, Statistique, Mathématiques Appliquées ou Informatique",
          },
          {
            label:
              "Minimum 2 ans d'expérience en modélisation prédictive ou machine learning",
          },
          { label: "Maîtrise de Python ou R (pandas, scikit-learn, XGBoost…)" },
          {
            label:
              "Bonne connaissance de SQL et des bases de données relationnelles",
          },
          { label: "Expérience Spark / Databricks appréciée" },
          {
            label:
              "Capacité à vulgariser les résultats pour des interlocuteurs non techniques",
          },
        ],
      },
      { type: "heading", text: "Documents requis", level: 2 },
        ...
        items: [
          {
            label: "Curriculum Vitae",
            detail:
              "PDF 2 pages — listez explicitement vos projets data et technologies utilisées",
          },
          {
            label: "Lettre de motivation",
            detail:
              "Avec un exemple de modèle développé et déployé en production",
          },
          {
            label: "Lien GitHub ou portfolio",
            detail:
              "Fortement recommandé — des projets publics démontrant votre niveau technique",
          },
        ],
      },
      {
        ...
        items: [
          {
            label: "Candidature via le site carrières BOA ou LinkedIn",
            desc: "Assurez-vous d'inclure un lien GitHub actif dans votre CV.",
          },
          {
            label: "Screening RH + test technique à domicile",
            desc: "Exercice data science de 3 à 4 heures : nettoyage, modélisation et interprétation.",
          },
          {
            label: "Entretien technique",
            desc: "Discussion de 60 minutes avec le Lead Data Scientist sur votre test et vos choix méthodologiques.",
          },
          {
            label: "Entretien manager",
            desc: "Rencontre avec le Directeur Data & IA pour valider l'adéquation culturelle et les perspectives.",
          },
        ],
      },
      {
...
export const events: Event[] = [
  {
    ...
    dateISO: "2026-04-15",
    excerpt:
      "Le plus grand rendez-vous tech du continent réunit startups, investisseurs et décideurs pour définir l'agenda numérique africain des cinq prochaines années.",
    ...
    blocks: [
      {
        type: "paragraph",
        text: "AfricaTech Summit est le plus grand rendez-vous technologique du continent africain. Chaque année, il rassemble à Nairobi les fondateurs de startups les plus prometteuses, les investisseurs les plus actifs et les décideurs institutionnels qui façonnent l'agenda numérique africain.",
      },
      {
        type: "paragraph",
        text: "En 2026, le sommet se concentre sur trois axes majeurs : l'intelligence artificielle appliquée aux défis africains, la fintech et l'inclusion financière, et les infrastructures cloud nécessaires à la souveraineté numérique du continent.",
      },
      { type: "heading", text: "Programme", level: 2 },
      {
        ...
        sessions: [
          ...
          {
            time: "09:30",
            title: "Cérémonie d'ouverture — L'Afrique numérique en 2030",
            speaker: "Keynote · Directeur AfricaTech Foundation",
            highlight: true,
            tag: "Keynote",
          },
          {
            time: "10:30",
            title: "Panel : IA africaine — souveraineté et adoption",
            speaker: "4 intervenants senior",
          },
          { time: "12:00", title: "Déjeuner & networking", tag: "Networking" },
          {
            time: "14:00",
            title: "Ateliers parallèles — Fintech · Cloud · IA santé",
          },
          {
            time: "16:00",
            title: "Pitches startups — finale des 20 sélectionnés",
            highlight: true,
            tag: "Live",
          },
          {
            time: "18:00",
            title: "Annonce des lauréats & cocktail de clôture",
            tag: "Remise de prix",
          },
        ],
      },
        ...
        items: [
          {
            icon: "🤝",
            label: "Networking",
            value: "5 000+ décideurs tech africains",
            highlight: true,
          },
          {
            icon: "💡",
            label: "Insights",
            value: "40+ panels et keynotes",
            highlight: false,
          },
          {
            icon: "🚀",
            label: "Startups",
            value: "150 startups en Demo Zone",
            highlight: false,
          },
          {
            icon: "💰",
            label: "Deals",
            value: "Salle deal-flow investisseurs",
            highlight: true,
          },
          {
            icon: "📡",
            label: "Live stream",
            value: "Sessions en streaming gratuit",
            highlight: false,
          },
          {
            icon: "🏆",
            label: "Prix",
            value: "AfricaTech Awards — 50 000 $",
            highlight: false,
          },
        ],
      },
      {
        type: "alert",
        message:
          "Les places en présentiel sont limitées à 5 000 participants. L'édition 2025 a affiché complet 6 semaines avant l'événement — inscrivez-vous tôt.",
        variant: "warning",
      },
      {
        type: "location",
        label: "Nairobi, Kenya",
        address:
          "Kenyatta International Convention Centre (KICC), City Square, Nairobi",
      },
      {
        type: "apply",
        label: "Réservez votre place à AfricaTech Summit 2026",
        url: "https://africatechsummit.com/register",
        note: "Tarif early-bird disponible jusqu'au 15 mars 2026. Réductions disponibles pour les étudiants et startups.",
        deadline: "15 Avr 2026",
      },
    ],
  },
  {
    ...
    dateISO: "2026-04-22",
    excerpt:
      "Trois jours de dialogues, ateliers et networking pour les jeunes leaders africains. Emploi, entrepreneuriat et engagement civique au cœur des débats.",
    ...
    blocks: [
      {
        type: "paragraph",
        text: "Le Forum Panafricain de la Jeunesse est la plateforme de référence des jeunes leaders africains âgés de 18 à 35 ans. Organisé sous l'égide de l'Union Africaine, il rassemble chaque année à Dakar des milliers de participants pour trois jours de débats, d'ateliers pratiques et de networking intensif.",
      },
      {
        type: "paragraph",
        text: "L'édition 2026 place l'employabilité et l'entrepreneuriat au centre, avec une attention particulière sur l'économie numérique, l'agritech et les métiers d'avenir sur le continent.",
      },
        ...
        sessions: [
          {
            time: "Jour 1",
            title:
              "Ouverture officielle & plénière : Jeunesse africaine en 2030",
            highlight: true,
            tag: "Plénière",
          },
          {
            time: "Jour 1",
            title: "Panels thématiques : Emploi, Tech, Engagement civique",
          },
          {
            time: "Jour 2",
            title: "Ateliers pratiques — Entrepreneuriat, CV, Pitch",
            tag: "Workshop",
          },
          {
            time: "Jour 2",
            title: "Speed networking — 500 jeunes leaders en simultané",
            highlight: true,
            tag: "Networking",
          },
          {
            time: "Jour 3",
            title: "Hackathon jeunesse — solutions aux défis locaux",
            tag: "Hackathon",
          },
          {
            time: "Jour 3",
            title: "Clôture & remise des Prix Jeunes Leaders UA",
            highlight: true,
            tag: "Cérémonie",
          },
        ],
        ...
        items: [
          {
            icon: "🎓",
            label: "Formation",
            value: "20 ateliers certifiants sur 3 jours",
            highlight: true,
          },
          {
            icon: "🤝",
            label: "Réseau",
            value: "1 200+ jeunes leaders de 54 pays",
            highlight: false,
          },
          {
            icon: "💼",
            label: "Emploi",
            value: "Job fair avec 80 recruteurs africains",
            highlight: true,
          },
          {
            icon: "🏆",
            label: "Compétition",
            value: "Prix Jeunes Leaders UA — bourses et mentorat",
            highlight: false,
          },
        ],
      },
      {
        type: "apply",
        label: "Participez au Forum Panafricain de la Jeunesse 2026",
        url: "https://au.int/fpj2026",
        note: "Participation gratuite pour les ressortissants des pays membres de l'UA. Transport et hébergement à la charge du participant.",
  ...
  },
  {
    ...
    dateISO: "2026-05-08",
    excerpt:
      "Le rendez-vous incontournable des dirigeants d'entreprises opérant en Afrique — deals, panels de haut niveau et networking d'élite sur fond de croissance continentale.",
    ...
    blocks: [
      ...
      { type: "heading", text: "Programme (Jour 1)", level: 2 },
      {
        ...
        sessions: [
          {
            time: "09:00",
            title: "Ouverture — L'Afrique dans l'économie mondiale 2026",
            highlight: true,
            tag: "Keynote",
          },
          {
            time: "10:30",
            title: "Panel : Investissements étrangers directs — nouvelle donne",
            speaker: "CEOs · Banquiers · Ministres",
          },
          {
            time: "12:30",
            title: "Déjeuner d'affaires — tables rondes sectorielles",
            tag: "Networking",
          },
          {
            time: "14:30",
            title: "Roundtables CEO — sessions fermées par secteur",
            tag: "Invite only",
          },
          {
            time: "17:00",
            title: "Annonces & MOU signing ceremony",
            highlight: true,
          },
        ...
        items: [
          {
            ...
            value: "400+ DG de banques et fonds",
            highlight: true,
          },
          {
            icon: "⚡",
            label: "Énergie",
            value: "Leaders du pétrole, gaz et ENR",
            highlight: false,
          },
          {
            icon: "📡",
            label: "Télécoms & Tech",
            value: "CEOs des majors africains",
            highlight: false,
          },
          {
            icon: "🏗️",
            label: "Infrastructure",
            value: "BTP, ports, routes, immobilier",
            highlight: false,
          },
          {
            icon: "🌾",
            label: "Agro-industrie",
            value: "Transformateurs et exportateurs",
            highlight: false,
          },
          {
            icon: "🏛️",
            label: "Gouvernements",
            value: "Ministres et régulateurs",
            highlight: true,
          },
        ],
      },
      {
        type: "alert",
        message:
          "L'accès à l'Africa CEO Forum est sur invitation ou accréditation presse. Soumettez votre candidature avant le 1er avril 2026.",
        variant: "info",
      },
      {
        type: "location",
        label: "Abidjan, Côte d'Ivoire",
        address: "Sofitel Abidjan Hôtel Ivoire, Boulevard Hassan II, Cocody",
      },
      {
        type: "apply",
        label: "Demandez votre accréditation — Africa CEO Forum 2026",
        url: "https://africaceoforum.com/register",
        note: "Accréditation sous réserve de validation par le comité organisateur. Réponse sous 10 jours ouvrés.",
  ...
  },
  {
    ...
    dateISO: "2026-06-20",
    excerpt:
      "72 heures pour concevoir des solutions d'IA face aux défis climatiques africains. 500 développeurs et designers en compétition pour 150 000 $.",
    ...
    blocks: [
      ...
      { type: "heading", text: "Déroulement des 72h", level: 2 },
      {
        ...
        sessions: [
          {
            time: "Vendredi 20h",
            title: "Kick-off — briefing des challenges & formation des équipes",
            highlight: true,
            tag: "Ouverture",
          },
          {
            time: "Samedi",
            title: "72h de hacking continu — mentors disponibles 24h/24",
            tag: "Build",
          },
          {
            time: "Dimanche 18h",
            title: "Soumission des projets — deadline stricte",
          },
          {
            time: "Dimanche 20h",
            title: "Pitches finaux — 6 équipes sélectionnées",
            highlight: true,
            tag: "Finale",
          },
          {
            time: "Dimanche 22h",
            title: "Remise des prix — 150 000 $ à partager",
            highlight: true,
            tag: "Remise de prix",
          },
        ],
        ...
        items: [
          {
            icon: "💰",
            label: "Prix total",
            value: "150 000 $ à remporter",
            highlight: true,
          },
          {
            icon: "🚀",
            label: "Accélération",
            value: "Top 3 : accès à un programme d'incubation",
            highlight: true,
          },
          {
            icon: "🌍",
            label: "Participants",
            value: "500 talents de 30+ pays africains",
            highlight: false,
          },
          {
            icon: "🧑‍🏫",
            label: "Mentors",
            value: "60 experts IA, climat et entrepreneuriat",
            highlight: false,
          },
        ],
      },
      {
        type: "checklist",
        title: "Ce que vous devez apporter",
        items: [
          {
            label: "Ordinateur portable chargé",
            detail: "Prises disponibles sur place mais limitées",
          },
          {
            label: "Accès GitHub ou GitLab actif",
            detail: "La soumission finale se fait via un repo public",
          },
          {
            label: "Compte Hugging Face ou GCP",
            detail: "Des crédits cloud sont distribués au kick-off",
          },
          {
            label: "Votre stack de prédilection",
            detail: "Python / JS / Rust — tout est accepté",
          },
        ],
      },
      {
        type: "apply",
        label: "Inscrivez votre équipe au Hackathon IA & Climat 2026",
        url: "https://greentech-africa.com/hackathon",
        note: "Inscriptions par équipes de 3 à 5 personnes. Solo possible — des équipes se forment également au kick-off.",
  ...
  },
  {
    ...
    dateISO: "2026-07-12",
    excerpt:
      "Les 300 entrepreneurs africains les plus influents se réunissent pour définir les priorités de l'écosystème — annonces de fonds et partenariats stratégiques.",
    organizer: "African Entrepreneurs Network",
    attendees: "800+",
    imageGradient:
      "linear-gradient(135deg, #1a0010 0%, #300020 40%, #480030 70%, #280018 100%)",
    tags: ["Entrepreneuriat", "Scale-up", "Levées de fonds"],
    featured: true,
    blocks: [
      {
        type: "paragraph",
        text: "Le Sommet des Entrepreneurs Africains réunit chaque année à Lagos les 300 fondateurs les plus influents du continent pour deux jours de discussions à huis clos, d'annonces stratégiques et de networking de très haut niveau. C'est ici que se décident les grandes alliances et levées de fonds de l'écosystème africain.",
      },
      { type: "heading", text: "Programme", level: 2 },
      {
        type: "agenda",
        sessions: [
          {
            time: "Jour 1 matin",
            title: "État de l'écosystème — baromètre annuel AEN",
            highlight: true,
            tag: "Plénière",
          },
          {
            time: "Jour 1 après-midi",
            title: "Tables rondes founders — sessions Chatham House",
          },
          {
            time: "Jour 1 soir",
            title: "African Founders Dinner — 300 invités",
            tag: "Gala",
          },
          {
            time: "Jour 2 matin",
            title: "Annonces de fonds & closing ceremony",
            highlight: true,
            tag: "Annonces",
          },
          {
            time: "Jour 2 après-midi",
            title: "Speed meetings investisseurs-startups",
            tag: "Deal flow",
          },
        ],
      },
      ...
      {
        type: "compare",
        title: "Sommet AEN vs autres grands forums africains",
        columns: [
      ...
      {
        type: "apply",
        label: "Postulez au Sommet des Entrepreneurs Africains 2026",
        url: "https://african-entrepreneurs.net/sommet2026",
        note: "Accès sur candidature uniquement. Profil minimum : fondateur d'une startup ayant levé 500k$ ou générant 1M$ de revenus annuels.",
  ...
  },
  {
    ...
    dateISO: "2026-08-03",
    excerpt:
      "La BAD réunit régulateurs, banquiers et fintechs pour co-construire le cadre réglementaire de la finance numérique panafricaine.",
    ...
    blocks: [
      {
        type: "paragraph",
        text: "Organisé par la Banque Africaine de Développement, cet atelier de haut niveau réunit régulateurs, banques centrales et leaders de la fintech africaine pour un exercice unique : co-construire ensemble les recommandations réglementaires de la finance numérique panafricaine.",
      },
      {
        type: "paragraph",
        text: "Format délibérément restreint à 250 participants pour favoriser des échanges approfondis. Les conclusions alimenteront directement le rapport politique de la BAD présenté aux chefs d'État lors du prochain Sommet de l'UA.",
      },
      { type: "heading", text: "Agenda de l'atelier", level: 2 },
      {
        ...
        sessions: [
          {
            time: "09:00",
            title: "Ouverture — Vice-Président BAD Finance",
            highlight: true,
          },
          {
            time: "09:45",
            title:
              "Présentation : état de la régulation fintech sur le continent",
          },
          {
            time: "11:00",
            title: "Atelier 1 — Interopérabilité des paiements mobiles",
            tag: "Workshop",
          },
          { time: "12:30", title: "Déjeuner de travail" },
          {
            time: "14:00",
            title: "Atelier 2 — KYC, AML et inclusion financière",
            tag: "Workshop",
          },
          {
            time: "15:30",
            title: "Atelier 3 — Open Banking : standards communs",
            tag: "Workshop",
          },
          {
            time: "17:00",
            title: "Synthèse & adoption des recommandations",
            highlight: true,
          },
        ],
      },
      ...
      },
      {
        type: "alert",
        message:
          "Cet atelier est sur invitation uniquement. Les candidatures externes sont examinées par le comité BAD. Seuls les profils régulateurs, banquiers centraux et CEO fintech sont éligibles.",
        variant: "info",
      },
      {
        type: "apply",
        label: "Soumettez votre candidature à l'Atelier FinTech BAD",
        url: "https://afdb.org/events/fintech-workshop-2026",
        note: "Invitation ou candidature avec lettre de motivation. Réponse de la BAD sous 3 semaines.",
        deadline: "03 Aoû 2026",
      },
    ],
  },
  {
    ...
    dateISO: "2026-09-18",
    excerpt:
      "Un espace dédié aux femmes leaders africaines — politiques, entrepreneures, militantes — pour partager, inspirer et tisser des réseaux d'influence durables.",
    ...
    blocks: [
      {
        type: "paragraph",
        text: "L'African Women Leadership Forum est le rendez-vous annuel des femmes qui font bouger l'Afrique. Politiques, entrepreneures, scientifiques, militantes : 600 femmes d'exception se retrouvent à Kigali — ville symbole d'une Afrique qui place les femmes au cœur de son développement.",
      },
      { type: "heading", text: "Programme", level: 2 },
      {
        type: "agenda",
        sessions: [
          {
            time: "Matin J1",
            title: "Plénière d'ouverture — Women shaping Africa 2026",
            highlight: true,
            tag: "Keynote",
          },
          {
            time: "Après-midi J1",
            title: "Panels sectoriels — Tech, Finance, Politique, Sciences",
          },
          {
            time: "Soir J1",
            title: "Dîner de mentorat — 60 tables de 10",
            tag: "Networking",
          },
          {
            time: "Matin J2",
            title:
              "Ateliers leadership — Négociation, Prise de parole, Fundraising",
            tag: "Workshop",
          },
          {
            time: "Après-midi J2",
            title: "AWLF Awards — 10 Prix Leadership Féminin Africain",
            highlight: true,
            tag: "Cérémonie",
          },
        ],
      ...
      {
        type: "pullquote",
        text: "Quand les femmes africaines se réunissent, le continent avance. Ce forum est un accélérateur d'histoire.",
        author: "Fondatrice, WomenAfrica Initiative",
      },
      {
        type: "apply",
        label: "Participez à l'African Women Leadership Forum 2026",
        url: "https://womenafrica.org/forum2026",
        note: "Forum ouvert à toutes les femmes leaders africaines. Candidature recommandée pour les sessions VIP et tables de mentorat.",
  ...
  },
  {
    ...
    dateISO: "2026-10-05",
    excerpt:
      "Scientifiques, ministres et ONG évaluent les engagements climatiques du continent et accélèrent les financements verts lors de cette semaine annuelle.",
    organizer: "PNUE · Nations Unies",
    attendees: "3 000+",
    imageGradient:
      "linear-gradient(135deg, #001810 0%, #003020 40%, #004830 70%, #002010 100%)",
    tags: ["Climat", "COP", "Financement vert"],
    featured: true,
    blocks: [
      {
        type: "paragraph",
        text: "Africa Climate Week est l'événement climatique de référence du continent africain, organisé chaque année par le PNUE en préparation de la COP mondiale. Il réunit scientifiques du GIEC, ministres de l'environnement, ONG, et secteur privé pour mesurer les progrès, identifier les lacunes et mobiliser les financements verts.",
      },
      {
        type: "paragraph",
        text: "L'édition 2026 au Caire intervient à un moment critique : l'Afrique, responsable de seulement 4 % des émissions mondiales, subit de plein fouet les impacts du dérèglement climatique. Le financement des pertes et dommages sera au cœur des négociations.",
      },
      { type: "heading", text: "Programme de la semaine", level: 2 },
      {
        ...
        sessions: [
          {
            time: "Jour 1",
            title: "Rapport GIEC Afrique 2026 — présentation officielle",
            highlight: true,
            tag: "Rapport",
          },
          {
            time: "Jour 2",
            title: "Négociations techniques — pertes, dommages et adaptation",
          },
          {
            time: "Jour 3",
            title: "Finance verte — mobilisation des 100 milliards promis",
            highlight: true,
            tag: "Finance",
          },
          {
            time: "Jour 4",
            title:
              "Journée secteur privé — entreprises et transition bas carbone",
            tag: "Business",
          },
          {
            time: "Jour 5",
            title: "Adoption de la Déclaration du Caire & clôture",
            highlight: true,
            tag: "Clôture",
          },
        ],
      ...
      { type: "heading", text: "Intervenants clés", level: 2 },
      {
        ...
        people: [
          {
            name: "Sameh Shoukri",
            role: "Ministre des AE & Président COP27",
            org: "Gouvernement Égyptien",
            emoji: "🌿",
          },
          {
            name: "Inger Andersen",
      ...
      {
        type: "factbox",
        title: "Chiffres clés Africa Climate Week 2025",
        facts: [
      ...
      },
      {
        ...
        address:
          "Cairo International Convention Centre (CICC), Nasr City, Le Caire",
      },
      {
        type: "apply",
        label: "Accréditation Africa Climate Week 2026",
        url: "https://unfccc.int/acw2026",
        note: "Accréditation gratuite pour les représentants gouvernementaux, ONG accréditées et institutions de recherche. Secteur privé : formulaire spécifique.",
